...
class RegisterUser(QDialog):
    ...
    def __init__(self, database, server):
        ...
        self.label_passwd.setFixedSize(190, 15)
        ...
        self.label_conf.setFixedSize(190, 15)

        self.client_conf = QLineEdit(self)
        self.client_conf.setFixedSize(184, 20)
