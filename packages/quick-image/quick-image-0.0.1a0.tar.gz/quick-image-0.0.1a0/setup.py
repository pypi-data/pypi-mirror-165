...
setup(
    ...
    description='A simple and rapid image processing toolkit',  # Optional
    ...
    # https://packaging.python.org/specifications/core-metadata/#home-page-optional
     url='https://github.com/dhchenx/quick-image',  # Optional
    ...
    # larger catalog.
    keywords="image processing",  # Optional
