...
class ExternalOperatorCAPI(external_operator_abstract_api.ExternalOperatorAbstractAPI):
	...
	def external_operator_record(operator_main, func, operator_identifier, spec):
		...
		res = capi.dll.ExternalOperator_record(operator_main, func, utils.to_char_ptr(operator_identifier), spec._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
	...
	def external_operator_record_with_abstract_core(operator_main, func, operator_identifier, spec, core):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_recordWithAbstractCore(operator_main, func, utils.to_char_ptr(operator_identifier), spec._internal_obj, core, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_record_with_abstract_core_and_wrapper(operator_main, func, operator_identifier, spec, core, wrapper):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_recordWithAbstractCoreAndWrapper(operator_main, func, utils.to_char_ptr(operator_identifier), spec._internal_obj, core, wrapper, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
