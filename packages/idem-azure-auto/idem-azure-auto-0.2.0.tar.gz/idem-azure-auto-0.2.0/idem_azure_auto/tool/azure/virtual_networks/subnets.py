...
def convert_present_to_raw_subnets(
    ...
    Args:
        hub: The redistributed pop central hub.
        address_prefix: The policy type. Possible values are BuiltIn, Custom and NotSpecified.
        enforce_private_link_endpoint_network_policies: The description of the policy definition.
        delegations: The display name of the policy definition.
        enforce_private_link_service_network_policies: The policy mode that allows you to specify which resource types will be evaluated. Some examples are All, Indexed, Microsoft.KeyVault.Data.
        service_endpoints: The metadata for the policy definition.
        service_endpoint_policy_ids: The policy rule for the policy definition.
    Returns:
