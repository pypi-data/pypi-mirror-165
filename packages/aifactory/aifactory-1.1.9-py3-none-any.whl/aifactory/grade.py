...
def submit_test(key, ipynb_name, func):
  current_cwd = os.getcwd()
  current = os.path.basename(__file__)
  print(current)
  ext = os.path.splitext(ipynb_name)[1]
  ...
  # sed.rmlinematch('aifactory','./requirements.txt')
  # sed.replace('main()', '#main()', './requirements.txt')
  # sed.replace('def #main()', 'def main()', './requirements.txt')
