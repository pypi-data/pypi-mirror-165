...
console.log('--- figInterface 1');
console.log('--- figInterface 2');
const deserializeReturnValue_1 = __importDefault(__webpack_require__(/*! ./deserializeReturnValue */ "./lib/deserializeReturnValue.js"));
console.log('--- figInterface 3');
console.log('--- figInterface 4');
console.log('--- figInterface 5');
...
const scaledDurationMsec = (n) => {
    if ((process) && (process.env.KACHERY_TEST_SPEEDUP_FACTOR)) {
...
console.log('--- widget.ts 1');
console.log('--- widget.ts 1.1');
const base_1 = __webpack_require__(/*! @jupyter-widgets/base */ "webpack/sharing/consume/default/@jupyter-widgets/base");
console.log('--- widget.ts 1.2');
