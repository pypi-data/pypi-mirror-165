...
class Task(GenericUsersideCategory):
    ...
    async def show(self, id: Union[str, int], employee_id: Optional[Union[str, int]] = None,
...
class UsersideAPI:
    def __init__(self, url: str, key: str):
        ...
        self._key = key
        self._session = None
        self._register_category('device', Device)
        self._register_category('commutation', Commutation)
        self._register_category('customer', Customer)
        self._register_category('node', Node)
        self._register_category('task', Task)
    ...
    def _register_category(self, category_name: str, category_class):
        setattr(self, category_name, category_class(self))
