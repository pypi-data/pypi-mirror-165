...
class Runner():
    ...
    def process_run_command(self, args):
        ...
        Order dependency analysis (updated: Aug-31-2022)
            ...
            - call to database.create_job_stats:
                - creates job_stats (with next_run_index=0)
            ...
            - When a node is started by the backend, the node will need to access:
                ...
                - the associated job_stats record (to allocate child run id's)

            - below call to store.log_job_info calls odbc.update_job_info which:
                - updates job_info
                - updates job_stats
                - creates job_tags
