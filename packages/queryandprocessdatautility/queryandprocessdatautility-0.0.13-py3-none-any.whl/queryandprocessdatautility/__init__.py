...
class IncentiveCalculation:
    ...
    def forecast(self):
        print("Forcast function start time", {datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")})
        ...
        if len(string_list) != 0:
            ...
            for i in range(0,len(drop_dataframe)):
                ...
                head = []
                valuesofdataframe = [0]
                print("Forcast New DataFrame creation and finding the same data, start time", {datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")})
                ...
                print("Forcast New DataFrame creation and finding the same data, end time", {datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")})
                print("Forcast function process start time", {datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")})
                for ind in lis:
                    ds.append(self.df[self.df.columns[dateindex]].values[ind])
                    y.append(self.df[self.df.columns[dateindex]].values[ind])
                ...
                print(forecast)
                print("Forcast function process End time", {datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")})
            ...
            print("Forcast function end time", {datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")})
            return self.df
            ...
            print("Forcast function call after add data")
            convert = json.loads(self.calculationData['columndataTypes'])
            dit = []
