...
def test_zzz():
    import pytest
    with pytest.raises(ValueError, match='lenght of label = 1 must match the number of plots = 2'):
        plot([[1, 4, 9], [-1, -4, -9]], '.-', label=['z'])
...
#    test_parse_pd()
#    test_parse_dicts()
    pytest.main([r'C:\Documents\python\bokehlab\bokehlab\__init__.py'])#_test_exceptions'])
#    test_exceptions()
