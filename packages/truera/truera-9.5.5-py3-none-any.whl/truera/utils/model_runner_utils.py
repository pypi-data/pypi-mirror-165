...
from truera.utils.package_requirement_utils import DEFAULT_PIP_VERSION
...
class CondaYamlParser:
    ...
    def _initialize_pip_modifications(self):
        ...
        if not contains_pip_dep:
            self.conda_yaml["dependencies"].append(f"pip={DEFAULT_PIP_VERSION}")
