...
class Table(object):
    ...
    def add_data_split(
        ...
        *,
        ...
        pre_data_additional_skip_cols=None,
        model_name=None,
        wait=True,
        timeout_seconds=300,
        ...
        **kwargs
        ...
        model_info_for_cache = ModelInfoForCache(
            self._project_id, model_name, None
        )
    ...
    def add_labels(
        ...
        **kwargs
        ...
        Args:
            existing_split_name (str): Name of the existing data split.
            label_col_name (str): Name of the label/ground truth/target column in the table.
            id_col_name (str): Name of the id column used to match labels with the corresponding data points.
            sample_count (int, optional): Maximum rows to use when creating the split. Defaults to 5000.
            sample_kind (str, optional): Specifies the strategy to use while sub-sampling the rows. One of ["random", "first"].
            wait (bool, optional): Whether to wait for the TruEra service to complete creating the data split. Defaults to True.
            timeout_seconds (int, optional): Timeout used when `wait` is set to True. Defaults to 300.
    ...
    def add_predictions(
        ...
        **kwargs
        ...
        Args:
            existing_split_name: Name of the existing data split.
        ...
        Returns:
            [dict]: Returns a dictionary with `data_split_name`, `operation_id` and `status` of the operation.
        """
        return self._add_delayed(
            existing_split_name=existing_split_name,
            id_col_name=id_col_name,
    ...
    def add_extra_data(
        ...
        **kwargs
        ...
        Args:
            existing_split_name (str): Name of the existing data split.
            extras_col_names (str): Name(s) of the extra data column(s) in the table.
            id_col_name (str): Name of the id column used to match labels with the corresponding data points.
            sample_count (int, optional): Maximum rows to use when creating the split. Defaults to 5000.
            sample_kind (str, optional): Specifies the strategy to use while sub-sampling the rows. One of ["random", "first"].
            wait (bool, optional): Whether to wait for the TruEra service to complete creating the data split. Defaults to True.
