...
class ScheduledIngestionClient():
    ...
    def schedule_new(
        ...
        req = scheduled_ingestion_pb.ScheduleIngestionRequest(
            request_template=template, schedule=schedule
        )
        return self.communicator.schedule_ingestion(req).workflow_id
    ...
    def schedule(
        ...
        req = scheduled_ingestion_pb.ScheduleIngestionRequest(
            request_template=request_template, schedule=schedule
        )
        return self.communicator.schedule_ingestion(req).workflow_id
