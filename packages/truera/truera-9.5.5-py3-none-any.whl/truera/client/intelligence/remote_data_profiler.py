...
class RemoteDataProfiler(DataProfiler):
    ...
    def get_schema_mismatch_rows_for_rowset(
        self,
        data_kind_str: str,
        table: Table,
        *,
        ...
        if not table or not table._rowset_id or not data_kind_str:
            raise ValueError(
                "table._rowset_id and data_kind_str must be populated"
            )
        self._ensure_schema_mismatch_api_constraints_are_initialized()
