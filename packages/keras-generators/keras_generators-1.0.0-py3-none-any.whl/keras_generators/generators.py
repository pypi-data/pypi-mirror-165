...
from .dtypes import ScaledNumTensorSeq, Scaler, NumTensorSeq
...
class XBatchGenerator(KerasSequence):
    def __init__(self,
                 inputs_map: Dict[str, ScaledNumTensorSeq],
                 batch_size: int = 128
                 ):
...
class XYBatchGenerator(XBatchGenerator):
    def __init__(self,
                 inputs_map: Dict[str, ScaledNumTensorSeq],
                 targets_map: Dict[str, ScaledNumTensorSeq],
                 shuffle: bool = True,
                 batch_size: int = 128
                 ):
...
class TrainData:
    def __init__(self,
                 inputs: Dict[str, NumTensorSeq],
                 targets: Dict[str, NumTensorSeq],
