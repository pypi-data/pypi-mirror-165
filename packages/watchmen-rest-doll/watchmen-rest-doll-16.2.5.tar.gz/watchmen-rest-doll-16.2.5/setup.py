...
['bcrypt>=3.2.0,<4.0.0',
 ...
 'watchmen-data-surface==16.2.5',
 'watchmen-indicator-surface==16.2.5',
 'watchmen-inquiry-surface==16.2.5',
 'watchmen-pipeline-surface==16.2.5']
...
{'kafka': ['kafka-python>=2.0.2,<3.0.0', 'aiokafka>=0.7.2,<0.8.0'],
 ...
 'mysql': ['watchmen-storage-mysql==16.2.5', 'cryptography>=36.0.2,<37.0.0'],
