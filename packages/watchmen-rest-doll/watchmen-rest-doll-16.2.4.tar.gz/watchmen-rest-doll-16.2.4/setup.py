...
['bcrypt>=3.2.0,<4.0.0',
 ...
 'watchmen-data-surface==16.2.4',
 'watchmen-indicator-surface==16.2.4',
 'watchmen-inquiry-surface==16.2.4',
 'watchmen-pipeline-surface==16.2.4']

extras_require = \
{'kafka': ['kafka-python>=2.0.2,<3.0.0', 'aiokafka>=0.7.2,<0.8.0'],
 'mongodb': ['watchmen-storage-mongodb==16.2.4'],
 'mssql': ['watchmen-storage-mssql==16.2.4'],
 'mysql': ['watchmen-storage-mysql==16.2.4', 'cryptography>=36.0.2,<37.0.0'],
 'oracle': ['watchmen-storage-oracle==16.2.4'],
 'oss': ['watchmen-storage-oss==16.2.4'],
 'postgresql': ['watchmen-storage-postgresql==16.2.4'],
 'prometheus': ['starlette-prometheus>=0.9.0,<0.10.0'],
 'rabbit': ['aio-pika>=7.1.2,<8.0.0'],
 's3': ['watchmen-storage-s3==16.2.4'],
 'sso': ['python3-saml>=1.14.0,<2.0.0', 'cryptography>=36.0.2,<37.0.0'],
 'standard_ext_writer': ['requests>=2.27.1,<3.0.0'],
 'trino': ['watchmen-inquiry-trino==16.2.4']}
