...
def parse_charges_func(args):
    ...
    coords = scell.cart_coords[without_central_indices]
    labels = scell.atom_labels[without_central_indices]

    cells.make_molcas_basis_and_xyz(labels, coords, charges)
    print("\033[93m")
    print("Molcas environment files written to:")
    print("     molcas_environment_basis.dat")
    print("     molcas_environment.xyz \033[0m")
    return
