...
class ZeroShotSuite(unittest.TestCase):
    folder = "/reZeroShot"
    ...
    pretrainedModelSavePath = "/home/ckl/old_home/ckl/Documents/freelance/jsl/jsl_internal_latest69696/tmp/trained_models/by_anno/re_zero/zero_shot_re_en_3.5.0_3.0_1648893990753"
    ...
    def buildAndFit(self, annoToFit) -> PipelineModel:
        ...
        #
        # re = ZeroShotRelationExtractionModel.pretrained().setRelationalCategories({
        #     "CURE": ["{TREsATMENT} cures {PROBLEM}."],
        #     "IMPROVE": ["{TREATMENsT} improves {PROBLEM}.", "{TREATMENT} cures {PROBLEM}."],
        #     "REVEAL": ["{TEST} reveals {PROBLEM}."], }).setPredictionThreshold(0.9).setMultiLabel(
        #     False).setInputCols(("sentences", "RENerChunks").setOutputCol("relations")
    ...
    def test_pretrained_model(self):
        ...
        trainedModel = pipelineModel.stages[9]
