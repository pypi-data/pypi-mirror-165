...
class FinanceNerApproach(A):
    ...
    @keyword_only
    def __init__(self):
        AnnotatorApproach.__init__(
            self, classname="com.johnsnowlabs.extensions.finance.token_classification.ner.FinanceNerApproach")
...
class _FinanceNerModelLoader(ExtendedJavaWrapper):
    def __init__(self, ner_model_path, path, jspark):
        super(_FinanceNerModelLoader, self).__init__(
            "com.johnsnowlabs.extensions.finance.token_classification.ner.FinanceNerModel.loadSavedModel",
...
class FinanceNerModel(M):
    ...
    def __init__(self, classname="com.johnsnowlabs.extensions.finance.token_classification.ner.FinanceNerModel",
                 java_model=None):
