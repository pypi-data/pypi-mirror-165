...
class FinanceNerDlSuite(unittest.TestCase):
    folder = "/FinNEr"
    ...
    pretrainedModelSavePath = "/home/ckl/old_home/ckl/Documents/freelance/jsl/jsl_internal_latest69696/tmp/trained_models/by_anno/med_ner/ner_jsl_en_3.1.0_3.0_1624284761441"
    ...
    def test_pretrained_model(self):
        anno_cls_to_test = sparknlp_jsl.finance.FinanceNerModel

        model = anno_cls_to_test.load(self.pretrainedModelSavePath).setInputCols("document", "tokens",
        ...
        trainedModel = pipelineModel.stages[3]
