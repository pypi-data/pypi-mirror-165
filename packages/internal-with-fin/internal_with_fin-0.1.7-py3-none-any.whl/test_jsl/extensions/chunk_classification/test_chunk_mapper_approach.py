...
class ChunkMapperApproachSuite(unittest.TestCase):
    ...
    def test_pretrained_model(self):
        # TODO NO TRAIN EXMAPLE??!?!?!
        model = sparknlp_jsl.extensions.finance.chunk_classification.ChunkMapperApproach() \
            .setInputCols("chunk")\
