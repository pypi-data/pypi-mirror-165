...
class Location:
    ...
    def get_adjusted_capacity(self, building_id):
        """
        ...
        :return: return get_adjusted_capacity

        """

        query, variables = self.basking.graphql_query.get_adjusted_capacity_graphql_query(
            building_id
        )
