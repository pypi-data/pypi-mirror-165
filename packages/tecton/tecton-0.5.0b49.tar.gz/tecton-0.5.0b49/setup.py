...
setuptools.setup(
    ...
    extras_require={'databricks-connect': ['databricks-connect~=9.1.23'], 'databricks-connect7': ['databricks-connect~=7.3.22'], 'databricks-connect9': ['databricks-connect~=9.1.23'], 'pyspark': ['pyspark~=3.1.2'], 'pyspark3': ['pyspark~=3.1.2'], 'pyspark3.1': ['pyspark~=3.1.2'], 'snowflake': ['snowflake-connector-python~=2.7'], 'athena': ['awswrangler~=2.15']},
    packages=packages,
)
