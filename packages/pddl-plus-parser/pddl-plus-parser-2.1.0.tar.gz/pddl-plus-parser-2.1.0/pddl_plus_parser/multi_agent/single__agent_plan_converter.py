...
class PlanConverter:
    ...
    def convert_plan(self, plan_file_path: Path, agent_names: List[str],
                     should_validate_concurrency_constraint: bool = True) -> List[JointActionCall]:
        ...
        with open(plan_file_path, "rt") as plan_file:
            ...
            plan_actions = self._create_joint_actions(plan_data, agent_names, should_validate_concurrency_constraint)
