...
class Application(Frame):
    ...
    def choose_download(self, meta, video, video_att, page_found, is_link, prev_page):
        ...
        available_audio_formats = {audio_filetypes["mp3"]:None, audio_filetypes["m4a"]:None, "ogg":None, audio_filetypes["aac"]:None, audio_filetypes["wav"]:None, "don't care":None}
...
if (__name__ != "__main__"):
    ...
    setting_file = SetupFile("setup.txt", os.getcwd())
