    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(method_options, dict):
            method_options = MethodOptions(**method_options)
        if __debug__:
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(client_domain_props, dict):
            client_domain_props = CfnDomainProps(**client_domain_props)
        if __debug__:
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(default_vpc_props, dict):
            default_vpc_props = VpcProps(**default_vpc_props)
        if isinstance(construct_vpc_props, dict):
            construct_vpc_props = VpcProps(**construct_vpc_props)
        if isinstance(user_vpc_props, dict):
            user_vpc_props = VpcProps(**user_vpc_props)
        if __debug__:
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(event_source_props, dict):
            event_source_props = StreamEventSourceProps(**event_source_props)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(output_bucket_props, dict):
            output_bucket_props = BucketProps(**output_bucket_props)
        if __debug__:
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(glue_job_props, dict):
            glue_job_props = CfnJobProps(**glue_job_props)
        if isinstance(kinesis_stream_props, dict):
            kinesis_stream_props = StreamProps(**kinesis_stream_props)
        if isinstance(lambda_function_props, dict):
            lambda_function_props = FunctionProps(**lambda_function_props)
        if isinstance(load_balancer_props, dict):
            load_balancer_props = ApplicationLoadBalancerProps(**load_balancer_props)
        if isinstance(logging_bucket_props, dict):
            logging_bucket_props = BucketProps(**logging_bucket_props)
