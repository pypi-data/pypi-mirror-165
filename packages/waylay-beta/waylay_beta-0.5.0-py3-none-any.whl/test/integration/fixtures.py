...
def waylay_test_gateway_url():
    """Get environment variable WAYLAY_TEST_GATEWAY_URL or 'https://api-staging.waylay.io'."""
    return get_test_env('WAYLAY_TEST_GATEWAY_URL', 'https://api-staging.waylay.io')
