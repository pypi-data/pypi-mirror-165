...
class PipeChecker(unittest.TestCase):
    ...
    def runTest(self):
        ...
        increase_percentatge = (checker_r.elapsed.total_seconds() - current_r.elapsed.total_seconds()) / current_r.elapsed.total_seconds()
        self.assertLess(
            increase_percentatge,
            0.25,
            msg=f"response time has increased {round(increase_percentatge * 100)}%"
        )
