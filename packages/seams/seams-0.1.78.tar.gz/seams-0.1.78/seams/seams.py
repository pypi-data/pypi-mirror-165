...
class Seams(object):
    ...
    def connect(self, 
        ...
        result = None
        result = app.acquire_token_silent(scopes=["https://partiddevb2c.onmicrosoft.com/{}/.default".format(app_id)], account=None)

        if not result:
            result = app.acquire_token_for_client(scopes=["https://partiddevb2c.onmicrosoft.com/{}/.default".format(app_id)])
        if 'error' in result:
