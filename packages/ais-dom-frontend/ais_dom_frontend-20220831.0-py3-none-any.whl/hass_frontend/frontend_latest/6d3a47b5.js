    ...
    `}},{kind:"method",key:"firstUpdated",value:function(e){v(y(i.prototype),"firstUpdated",this).call(this,e),(0,a.O)()}},{kind:"method",key:"_computeDeviceName",value:function(e,t){const i=e.find((e=>e.id===t));return i?(0,o.jL)(i,this.hass):`<${this.hass.localize("ui.panel.config.integrations.config_entry.unknown_via_device")}>`}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,r.iv`
      ...
      `;const f=(0,m.jL)(u,this.hass),v=this._integrations(u,this.entries),y=this._entities(this.deviceId,this.entities),g=this._entitiesByCategory(y),b=this._batteryEntity(y),w=this._batteryChargingEntity(y),k=b?this.hass.states[b.entity_id]:void 0,_=k&&"binary_sensor"===(0,l.N)(k),x=w?this.hass.states[w.entity_id]:void 0,$=this._computeArea(this.areas,u),z=[],P=[...this._deviceActions||[]];Array.isArray(this._diagnosticDownloadLinks)&&P.push(...this._diagnosticDownloadLinks),this._deleteButtons&&P.push(...this._deleteButtons),P.sort(((e,t)=>"warning"===e.classes&&"warning"!==t.classes?1:"warning"!==e.classes&&"warning"===t.classes?-1:0));const A=P.shift();u.disabled_by&&z.push(t.dy`
          ...
          ${"user"===u.disabled_by?t.dy`
              ...
              `:""}
        `),this._renderIntegrationInfo(u,v,z);const D=(0,s.p)(this.hass,"automation")?t.dy`
          <ha-card outlined>
...
//# sourceMappingURL=6d3a47b5.js.map