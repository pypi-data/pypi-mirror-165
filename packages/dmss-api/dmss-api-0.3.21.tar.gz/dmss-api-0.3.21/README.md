...
*ExplorerApi* | [**explorer_add**](docs/ExplorerApi.md#explorer_add) | **POST** /api/v1/explorer/{absolute_ref} | Add By Parent Id
*ExplorerApi* | [**explorer_add_simple**](docs/ExplorerApi.md#explorer_add_simple) | **POST** /api/v1/explorer/{data_source_id}/add-raw | Add Raw
*ExplorerApi* | [**explorer_add_to_path**](docs/ExplorerApi.md#explorer_add_to_path) | **POST** /api/v1/explorer/{data_source_id}/add-to-path | Add To Path
*ExplorerApi* | [**explorer_move**](docs/ExplorerApi.md#explorer_move) | **POST** /api/v1/explorer/{data_source_id}/move | Move
*ExplorerApi* | [**explorer_remove**](docs/ExplorerApi.md#explorer_remove) | **DELETE** /api/v1/explorer/{data_source_id}/{dotted_id} | Remove
*ExplorerApi* | [**explorer_remove_by_path**](docs/ExplorerApi.md#explorer_remove_by_path) | **POST** /api/v1/explorer/{data_source_id}/remove-by-path | Remove By Path
*ExplorerApi* | [**explorer_rename**](docs/ExplorerApi.md#explorer_rename) | **PUT** /api/v1/explorer/{data_source_id}/rename | Rename
