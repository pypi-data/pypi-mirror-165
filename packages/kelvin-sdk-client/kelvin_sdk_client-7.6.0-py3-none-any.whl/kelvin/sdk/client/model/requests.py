...
class AssetOEEGet(DataModelBase):
    ...
    timestamp: Optional[str] = Field(
        None,
        description="Timestamp to search for specific kelvin Asset related <a href='https://docs.kelvininc.com/latest/documentation/kelvin-maps/kelvin-maps-asset-details/#performance-details' target='_blank'>OEE</a>.</p> Values for a given point in time can be given in RFC3339 or Unix timestamps with nanosecond precision format.</p> If no timestamp is given in the query or Body parameters, then the current time will be selected.",
    )
...
class AssetStatistics(DataModelBase):
    ...
    search: Optional[List[str]] = Field(
        None,
        description="Array of strings to be used as an `OR` as a filter.</p> Each string will be used to search the field `name`, `title`, `asset_type_name`, `asset_type_title`, `entity_type_name` and `entity_type_title`. The search is case insensitive.",
    )
...
class ControlChangeCreate(DataModelBase):
    ...
    expiration_date: Optional[datetime] = Field(
        None,
        description="When the Control Change request will fail if it has not been processed and applied by this date/time.</p> Values for a given point in time must be given in RFC3339 format. e.g. `2022-08-12T00:00:00.000000Z`.</p> The default value is calculated by the formulae <strong>Now + (`timeout` * ( `retry` + 1 ))</strong>.",
    )
...
class FailureDetectionProperty(DataModelBase):
    ...
    unit: Optional[str] = Field(
        None,
        description='The units for the <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-ai-failure-detection/" target="_blank">Kelvin Failure Detection AI</a> property.</p> This can be changed by the user when adding the Kelvin Template as a new <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/" target="_blank">Kelvin Asset</a>.',
    )
    value: Optional[str] = Field(
        None,
        description='The default value for the <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-ai-failure-detection/" target="_blank">Kelvin Failure Detection AI</a> property.</p> This can be changed by the user when adding the Kelvin Template as a new <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/" target="_blank">Kelvin Asset</a>.',
    )
...
class AssetTemplateUpdate(DataModelBase):
    ...
    description: Optional[str] = Field(
        None,
        description="A full description of the Kelvin Template.</p> Maximum length is 512 characters including spaces.",
    )
    entity_type_name: Optional[str] = Field(
        None,
        description='Entity type that is linked to this new Kelvin Template.</p> There are 5 entity type options available to choose from; `group`, `asset`, `component`, `part` and `sensor`.</p> Detailed information about the asset hierarchy and function of each entity type can be found at <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/" target="_blank">https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/</a>.',
