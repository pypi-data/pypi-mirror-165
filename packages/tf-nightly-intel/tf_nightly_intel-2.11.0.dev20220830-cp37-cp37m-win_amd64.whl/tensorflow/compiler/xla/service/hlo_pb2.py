...
_JITRTEXECUTABLEPROTO = _descriptor.Descriptor(
  name='JitRtExecutableProto',
  full_name='xla.JitRtExecutableProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='hlo_module_proto', full_name='xla.JitRtExecutableProto.hlo_module_proto', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='entry_func_attrs', full_name='xla.JitRtExecutableProto.entry_func_attrs', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='obj_file', full_name='xla.JitRtExecutableProto.obj_file', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mlir_module', full_name='xla.JitRtExecutableProto.mlir_module', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_JITRTEXECUTABLEPROTO.fields_by_name['hlo_module_proto'].message_type = _HLOMODULEPROTO
_JITRTEXECUTABLEPROTO.fields_by_name['entry_func_attrs'].message_type = _ENTRYFUNCTIONATTRIBUTES
...
DESCRIPTOR.message_types_by_name['JitRtExecutableProto'] = _JITRTEXECUTABLEPROTO
