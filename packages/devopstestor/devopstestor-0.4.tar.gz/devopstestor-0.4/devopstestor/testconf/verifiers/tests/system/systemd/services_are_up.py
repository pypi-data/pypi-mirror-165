...
def test_services_are_running(host, argument_getter):
    """
    ...
    for service_name, service_checks in services_are_up.items():
        ...
        delay = service_checks.get('wait_before_checkstart', 120) # Delais a attentdre pour valider le bon lancement du service
