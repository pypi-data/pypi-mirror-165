...
class Control:
    ...
    def __init__(self, property_name, protobuf_path, protobuf_setter_fn, message, control_type, default_value, check_control_default_fn, display_ifs=None, header=None):
        """
        Create a Control.
        ...
        Args:
            ...
            protobuf_path (str or None): protobuf path corresponding to the control.
        ...
        self._protobuf_path = CHECK_TYPE(protobuf_path, str, allow_none=True)
    ...
    @property
    def protobuf_path(self):
        """Return the protobuf path"""
        return self._protobuf_path
