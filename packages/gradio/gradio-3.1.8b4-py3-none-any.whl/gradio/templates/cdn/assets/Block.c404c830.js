...
function create_dynamic_element(ctx) {
	...
	let svelte_element_levels = [
		...
		{ id: /*elem_id*/ ctx[0] },
		{
			class: svelte_element_class_value = "gr-block relative w-full overflow-hidden " + /*styles*/ ctx[10][/*variant*/ ctx[1]] + " " + (/*rounded*/ ctx[6]
	...
	return {
		c() {
			...
			toggle_class(svelte_element, "gr-box-unrounded", !/*rounded*/ ctx[6]);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			set_attributes(svelte_element, svelte_element_data = get_spread_update(svelte_element_levels, [
				...
				(!current || dirty & /*variant, rounded, color, classes, rounded_style*/ 838 && svelte_element_class_value !== (svelte_element_class_value = "gr-block relative w-full overflow-hidden " + /*styles*/ ctx[10][/*variant*/ ctx[1]] + " " + (/*rounded*/ ctx[6]
				? /*styles*/ ctx[10][/*color*/ ctx[2]]
