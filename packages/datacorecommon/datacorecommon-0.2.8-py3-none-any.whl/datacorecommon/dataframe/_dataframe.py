...
def _clean_columnname(_columnname: str, _casetype: str = 'lower') -> str:
    ...
    _casetype : str, default 'lower'
        ...
        Supported case types are camel (myColumnName), pascal (MyColumnName), snake (my_column_name), lower (XXXXX), kebab (my-column-name) and upper (MY_COLUMN_NAME). 
...
def clean_columnnames_dataframe(_df: DataFrame, _casetype: str = 'lower') -> DataFrame:
    ...
    -------
    DataFrame
        The dataframed with all the columns renamed to the new clean names.
