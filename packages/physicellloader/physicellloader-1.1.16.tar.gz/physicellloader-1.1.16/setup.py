...
setup(
    ...
    package_data={  # Optional
        #"physicellloader": ["matlab_example/*.mat", "matlab_example/*.xml", "matlab_example/*.svg", "matlab_example/citation and license.txt"],
        #"physicellloader": ["timeseries_set/*.mat", "timeseries_set/*.xml"],
        "physicellloader": ["*.mat", "*.xml", "*.svg", "citation and license.txt"],
    },
