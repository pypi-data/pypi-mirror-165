...
if __name__ == '__main__':
  ...
  m = ServerMigrator(directory=path+'kadanza', verbose=True, sourceChili='http://docs3.kadanza.com/chili/Axalta_Packaging_manager/interface.aspx', destChili='http://hyperchili.com/CHILI/Admin/interface.aspx')

  m.transferResource(resource='assets', parentFolder='EMEA-labels\\')
