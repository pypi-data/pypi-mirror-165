    ...
    async def parse_lines(self, _file, lines):
        ...
        for line in lines:
            ...
            if m:
                ...
                await self.put(json.dumps(Message(type=MessageType.SERVER_INFO, body=self._server_info),
            ...
            if m:
                ...
                await self.put(json.dumps(Message(type=MessageType.SESSION_INFO, body=self._session_info),
                                          cls=EnhancedJSONEncoder))
                continue
            ...
            if m:
                ...
                await self.put(json.dumps(Message(type=MessageType.DRIVER_INFO, body=self._driver_info),
                                          cls=EnhancedJSONEncoder))
                continue
