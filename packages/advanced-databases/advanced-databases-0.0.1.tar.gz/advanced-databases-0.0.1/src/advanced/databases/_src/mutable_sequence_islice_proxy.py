...
class MutableSequenceIsliceProxy(SequenceIsliceProxy[T], Generic[T]):
    _sequence: "src._viewable_mutable_sequence.ViewableMutableSequence[T]"

    __slots__ = ()

    def __init__(self: Self, sequence: "src._viewable_mutable_sequence.ViewableMutableSequence[T]", /) -> None:
        assert isinstance(sequence, src._viewable_mutable_sequence.ViewableMutableSequence)
        self._sequence = sequence

    def __getitem__(self: Self, index: slice, /) -> "src._mutable_sequence_islice.MutableSequenceIslice[T]":
        ...
        return src._mutable_sequence_islice.MutableSequenceIslice(self._sequence, start, stop, step)
