...
class UserGroupApi(object):
    ...
    def create_user_group(self, body, **kwargs):  # noqa: E501
        ...
        :param iam.v4.authn.UserGroup body: Create a user group (required)
    ...
    def create_user_group_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/iam/v4.0.a1/authn/user-groups', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_user_group_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        :param str extId: External Identifier of the user group (required)
        :param bool async_req:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_group_by_id_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_group_by_id_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def get_user_group_by_id_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Get user group
        View a user group
        ...
        >>> thread = api.get_user_group_by_id_with_http_info(extId, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/iam/v4.0.a1/authn/user-groups/{extId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
...
- tenantId
        ...
        return self.api_client.call_api(
            '/api/iam/v4.0.a1/authn/user-groups', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
