...
from geospacelab.datahub.sources.madrigal.isr.eiscat import Loader as default_Loader
from geospacelab.datahub.sources.madrigal.isr.eiscat import Downloader as default_Downloader
from geospacelab.datahub.sources.madrigal.isr.eiscat import *
