...
class ObjectStore(System.Object, QuantConnect.Interfaces.IObjectStore, typing.Iterable[System.Collections.Generic.KeyValuePair[str, typing.List[int]]]):
    ...
    def ContainsKey(self, key: str, prefix: str = None) -> bool:
        """
        Determines whether the store contains data for the specified key
        
        :param key: The object key
        :param prefix: Optionally the key prefix to use, will default to the project id
    ...
    def GetFilePath(self, key: str, prefix: str = None) -> str:
        """
    ...
    def Read(self, key: str, encoding: System.Text.Encoding = None, prefix: str = None) -> str:
        """
    ...
    def ReadBytes(self, key: str, prefix: str = None) -> typing.List[int]:
        """
    ...
    def ReadJson(self, key: str, encoding: System.Text.Encoding = None, settings: typing.Any = None, prefix: str = None) -> QuantConnect_Storage_ObjectStore_ReadJson_T:
        """
    ...
    def ReadString(self, key: str, encoding: System.Text.Encoding = None, prefix: str = None) -> str:
        """
        Returns the string object data for the specified key
    ...
    def ReadXml(self, key: str, encoding: System.Text.Encoding = None, prefix: str = None) -> QuantConnect_Storage_ObjectStore_ReadXml_T:
        """
    ...
    @overload
    def Save(self, key: str, text: str, encoding: System.Text.Encoding = None, prefix: str = None) -> bool:
        """
    ...
    def SaveBytes(self, key: str, contents: typing.List[int], prefix: str = None) -> bool:
        """
    ...
    def SaveJson(self, key: str, obj: QuantConnect_Storage_ObjectStore_SaveJson_T, encoding: System.Text.Encoding = None, settings: typing.Any = None, prefix: str = None) -> bool:
        """
    ...
    def SaveString(self, key: str, text: str, encoding: System.Text.Encoding = None, prefix: str = None) -> bool:
        """
        Saves the object data in text format for the specified key
    ...
    def SaveXml(self, key: str, obj: QuantConnect_Storage_ObjectStore_SaveXml_T, encoding: System.Text.Encoding = None, prefix: str = None) -> bool:
        """
