...
class TransformCategories(BaseObject):
    ...
    def process(self,
        ...
        # prevent long-winded stuff like 'Senior advisors to the office of the president of the republic of china'
        # anything that's too long won't display well on a graph anyway
