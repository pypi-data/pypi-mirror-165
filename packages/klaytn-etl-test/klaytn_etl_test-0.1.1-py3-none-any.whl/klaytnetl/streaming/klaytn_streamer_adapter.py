...
from klaytnetl.streaming.klaytn_item_timestamp_calculator import KlaytnItemTimestampCalculator
...
class KlaytnStreamerAdapter:
    def __init__(
        ...
        self.item_timestamp_calculator = KlaytnItemTimestampCalculator()
