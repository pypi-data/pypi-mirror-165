...
class Bubble:
    def __init__(self, path=os.getcwd(),file='bubble.xlsx'):
    ...
    def pic_save(self, conf,output_name):
    ...
    def bubble_plot(self, path=None, file_type='.pdf', path_img=None, x_col_name=None, y_col_name=None,
