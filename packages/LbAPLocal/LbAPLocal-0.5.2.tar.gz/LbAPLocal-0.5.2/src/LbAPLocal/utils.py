...
def logging_subprocess_run(args, *, shell=False, cwd=None, printing=True):
    return asyncio.get_event_loop().run_until_complete(
        _logging_subprocess_run(*args, shell=shell, cwd=cwd, printing=printing)
    )


async def _logging_subprocess_run(*command, shell, cwd, printing):
