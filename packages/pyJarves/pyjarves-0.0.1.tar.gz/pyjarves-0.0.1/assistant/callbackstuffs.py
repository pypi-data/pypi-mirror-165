...
try:
    from pyJarves.fns.gDrive import GDriveManager
except ImportError:
    GDriveManager = None
...
from pyJarves.fns.helper import fast_download, progress
from pyJarves.fns.tools import Carbon, async_searcher, get_paste, telegraph_client
from pyJarves.startup.loader import Loader
...
async def update(eve):
    ...
    if heroku_api:
        ...
        execl(sys.executable, sys.executable, "-m", "pyJarves")
