...
- It's base core is a pip package named [`pyJarvis`](https://GitHub.com/TeamUltroid/pyJarvis).
- This repository, contains Ultroid's official plugin files.
- moreover, Ultroid User also have an option to get more plugins available at [`UltroidAddons`](https://github.com/MrCode403/JarvesAddons)
...
### Contributing
- You can [fork](https://github.com/MrCode403/Jarves/fork) this repository.
