...
from pyJarves.version import __version__ as UltVer
...
async def restartbt(ult):
    ...
    if len(sys.argv) > 1:
        ...
        os.execl(sys.executable, sys.executable, "-m", "pyJarves")
...
async def _(e):
    ...
    if e.pattern_match.group(1).strip() and (
        ...
        os.execl(sys.executable, "python3", "-m", "pyJarves")
        # return
    m = await updater()
    ...
    if m:
        ...
        await xx.edit(
            f'<code>Your BOT is </code><strong>up-to-date</strong><code> with </code><strong><a href="https://github.com/MrCode403/Jarves/tree/{branch}">[{branch}]</a></strong>',
            parse_mode="html",
            link_preview=False,
        )
