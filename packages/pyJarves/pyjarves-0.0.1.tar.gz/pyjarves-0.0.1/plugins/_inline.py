...
from pyJarves._misc._assistant import callback, in_pattern
from pyJarves.dB._core import HELP, LIST
from pyJarves.fns.helper import gen_chlog, time_formatter, updater
from pyJarves.fns.misc import split_list
...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/MrCode403/Jarves"),
