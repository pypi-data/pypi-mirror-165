...
{data['query']}
            """, globals())
            return _database.read_sql_query(table_id=data['table'], query_function=query, pk_column=data['pk_column'], meta=data['meta'])
...
class DatabaseManagement(Base):
    ...
    def write_sql_query(self, query_function=None, directory_id=None, table_id=None, pk_column=None, meta=None, name=None, desciption=None, *args, **kwargs):
