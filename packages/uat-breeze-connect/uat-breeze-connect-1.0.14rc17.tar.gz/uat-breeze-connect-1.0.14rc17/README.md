...
<ul>
 <li><a href="#Uat_Breeze_Connect_SDK">UAT_Breeze_Connect_SDK</a></li>
 <li><a href="#Setup">Setup Virtual Environment</a></li>
 <li><a href="#Installing">Installing the client</a></li>
...
<h4 id="#Uat_Breeze_Connect_SDK">UAT Breeze Connect</h4>
...
<h4 id="#Setup">Setup virtual environment in your Machine</h4>
...
<h4 id="#Installing">Installing the client</h4>
...
```
pip install uat-breeze-connect==1.0.14rc17
```
