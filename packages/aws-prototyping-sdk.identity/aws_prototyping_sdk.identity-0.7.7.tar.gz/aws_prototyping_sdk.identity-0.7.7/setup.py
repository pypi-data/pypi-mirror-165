    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cognito-identitypool-alpha==2.39.0.a0",
        "aws_prototyping_sdk.pdk_nag>=0.7.5, <0.8.0",
        "cdk-nag>=2.16.5, <3.0.0",
        "constructs>=10.1.90, <11.0.0",
        "jsii>=1.65.0, <2.0.0",
        "projen>=0.61.31, <0.62.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
    "classifiers": [
