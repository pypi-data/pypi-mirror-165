...
class AGCreateSecurityPostgres:
    ...
    def create_view_user_groups(self):
        cur = self.conn.cursor(cursor_factory=psycopg2.extras.NamedTupleCursor)
        query = open("./sql_queries/create_view_user_groups.sql", "r").read()
        cur.execute(query)
        self.conn.commit()
        cur.close()
    ...
    def create_function_table_rights(self):
        cur = self.conn.cursor(cursor_factory=psycopg2.extras.NamedTupleCursor)
        query = open("./sql_queries/create_fn_table_rights.sql", "r").read()
        cur.execute(query)
        self.conn.commit()
        cur.close()
    ...
    def create_function_view_rights(self):
        cur = self.conn.cursor(cursor_factory=psycopg2.extras.NamedTupleCursor)
        query = open("./sql_queries/create_fn_view_rights.sql", "r").read()
        cur.execute(query)
        self.conn.commit()
        cur.close()
    ...
    def create_function_stored_procedure_rights(self):
        cur = self.conn.cursor(cursor_factory=psycopg2.extras.NamedTupleCursor)
        query = open("./sql_queries/create_fn_stored_procedure_rights.sql", "r").read()
        cur.execute(query)
        self.conn.commit()
        cur.close()
    ...
    def create_function_user_groups(self):
        cur = self.conn.cursor(cursor_factory=psycopg2.extras.NamedTupleCursor)
        query = open("./sql_queries/create_fn_user_groups.sql", "r").read()
        cur.execute(query)
        self.conn.commit()
        cur.close()
    ...
    def create_function_table_exists(self):
        cur = self.conn.cursor(cursor_factory=psycopg2.extras.NamedTupleCursor)
        query = open("./sql_queries/create_fn_table_exists.sql", "r").read()
        cur.execute(query)
        self.conn.commit()
        cur.close()
    ...
    def create_function_record_exists(self):
        cur = self.conn.cursor(cursor_factory=psycopg2.extras.NamedTupleCursor)
        query = open("./sql_queries/create_fn_record_exists.sql", "r").read()
        cur.execute(query)
        self.conn.commit()
        cur.close()
