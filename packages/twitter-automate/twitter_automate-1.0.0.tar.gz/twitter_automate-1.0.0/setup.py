...
setuptools.setup(
    ...
    version=VERSION, 
    description="This library allow to do automatisation actions like, share and comment on social network",
    ...
    keywords=[
        'kaisens', 'kai', 'automate', 'kai_automate',
        'kai-automate', 'linkedin', 'twitter',
        'automatisation',
    ],
)
