...
with open("description/description.md", "r", encoding="utf-8") as description_file:
...
setuptools.setup(
    ...
    version=VERSION, 
    description="This library allow to do automatisation actions like, share and comment on Twitter",
    ...
    keywords=[
        'automate', 'twitter-automate','twitter',
        'automatisation',
    ],
)
