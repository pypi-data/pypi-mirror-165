...
class Webhook(object):
    ...
    def construct_event(
        ...
        WebhookSignature.verify_header(payload, digest_header, signature_header, request_id_header, pkey, tolerance)

        data = json.loads(payload, object_pairs_hook=OrderedDict)
        event = fintecture.Event.construct_from(data, app_id or fintecture.app_id)
