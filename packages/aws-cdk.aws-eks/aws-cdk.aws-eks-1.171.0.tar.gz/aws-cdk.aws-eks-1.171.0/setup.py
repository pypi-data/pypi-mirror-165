    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.custom-resources==1.171.0",
        "aws-cdk.lambda-layer-awscli==1.171.0",
        "aws-cdk.lambda-layer-kubectl==1.171.0",
        "aws-cdk.lambda-layer-node-proxy-agent==1.171.0",
