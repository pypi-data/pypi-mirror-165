    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.custom-resources==1.170.1",
        "aws-cdk.lambda-layer-awscli==1.170.1",
        "aws-cdk.lambda-layer-kubectl==1.170.1",
        "aws-cdk.lambda-layer-node-proxy-agent==1.170.1",
