...
class StorageContainer(ExternalizableAbstractModel):
    ...
    swagger_types = {
        ...
        'prefer_higher_e_c_fault_domain': 'bool',
    ...
    attribute_map = {
        ...
        'prefer_higher_e_c_fault_domain': 'preferHigherECFaultDomain',
    ...
    def __init__(self, container_id=None, container_ext_id=None, owner_uuid=None, name=None, cluster_ext_id=None, storage_pool_uuid=None, marked_for_removal=None, max_capacity=None, total_explicit_reserved_capacity=None, total_implicit_reserved_capacity=None, advertised_capacity=None, replication_factor=None, oplog_replication_factor=None, nfs_whitelist_address=None, is_nfs_whitelist_inherited=None, random_io_preference=None, seq_io_preference=None, down_migrate_times_in_secs=None, erasure_code=None, inline_ec_enabled=None, prefer_higher_e_c_fault_domain=None, erasure_code_delay_secs=None, finger_print_on_write=None, on_disk_dedup=None, compression_enabled=None, compression_delay_in_secs=None, is_nutanix_managed=None, enable_software_encryption=None, vstore_name_list=None, mapped_remote_containers=None, encrypted=None, affinity_host_uuid=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__prefer_higher_e_c_fault_domain = None
        ...
        if prefer_higher_e_c_fault_domain is not None:
            self.__prefer_higher_e_c_fault_domain = prefer_higher_e_c_fault_domain
    ...
    def _initialize_fq_object_type(self):
        return 'storage.v4.r0.a2.config.StorageContainer'
    ...
    @property
    def prefer_higher_e_c_fault_domain(self):
        """`{ bool }`
            \nIndicates whether to prefer a higher erasure code fault domain.
        """ # noqa: E501
        return self.__prefer_higher_e_c_fault_domain

    @prefer_higher_e_c_fault_domain.setter
    def prefer_higher_e_c_fault_domain(self, prefer_higher_e_c_fault_domain):
