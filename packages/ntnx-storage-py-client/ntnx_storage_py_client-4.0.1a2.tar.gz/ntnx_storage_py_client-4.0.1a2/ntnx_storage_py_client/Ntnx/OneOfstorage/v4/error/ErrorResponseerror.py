...
class ErrorResponseerror(object):
    ...
    discriminator_value_class_map = {
        'EMPTY_LIST': 'list[str]',
        'List<storage.v4.error.AppMessage>': 'list[storage.v4.error.AppMessage]',
        'storage.v4.error.SchemaValidationError': 'storage.v4.error.SchemaValidationError'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfstorage.v4.error.ErrorResponseerror'
