...
from ntnx_storage_py_client.Ntnx.OneOfstorage.v4.error.ErrorResponseerror import ErrorResponseerror  # noqa: F401,E501
...
class ErrorResponse(object):
    ...
    """ # noqa: E501
    swagger_types = {
        'error': 'OneOfstorage.v4.error.ErrorResponseerror',
    ...
    def _initialize_object_type(self):
        return 'storage.v4.error.ErrorResponse'

    def _initialize_fq_object_type(self):
        return 'storage.v4.r0.a2.error.ErrorResponse'
    ...
    @property
    def error(self):
        """`{ list[storage.v4.error.AppMessage] | storage.v4.error.SchemaValidationError }`
