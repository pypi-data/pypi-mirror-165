...
class DataStoreTaskResponsedata(object):
    """DataStoreTaskResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'OneOfstorage.v4.config.DataStoreTaskResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DataStoreTaskResponsedata.discriminator_value_class_map.values():
            return list(DataStoreTaskResponsedata.discriminator_value_class_map.keys())[list(DataStoreTaskResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataStoreTaskResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataStoreTaskResponsedata):
            return False
