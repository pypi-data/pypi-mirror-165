# Generated by Django 3.2.5 on 2022-08-25 07:28
...
# DEFAULT ENUM CLASS FOR ACTION AND STATES 
class Values(Enum):
    NO_SIGN = "NO_SIGN"
    DRAFT = "DRAFT"
    RETURN = "RETURN"
...
def create_sign_list(apps, schema_editor):
    ...
    db_alias = schema_editor.connection.alias
    states.objects.using(db_alias).create(name = Values.NO_SIGN, sign_id = 1 , sub_name = Values.NO_SIGN)
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_name', models.CharField(default=None, max_length=255)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage_required', models.ForeignKey(help_text='IMPORTANT : if 0 means initial_transition ',null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='finflo.signlist')),
