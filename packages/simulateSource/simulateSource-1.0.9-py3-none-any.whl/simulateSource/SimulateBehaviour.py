from SimulateSource import SimulateSource
class SimulateBehaviour(SimulateSource.ISimulateSourceInterface):
    ...
    def __init__(self, com):
        ...
        # traceSimulateParams.simulateDisplaySpeed = 60
        # traceSimulateParams.singleGain = 0
        # traceSimulateParams.fileName = "walk_route.txt"
        # traceSimulateParams.simulateTime = traceSimulateParams.simulateTimetest(2022,8,1,16,30,10)
