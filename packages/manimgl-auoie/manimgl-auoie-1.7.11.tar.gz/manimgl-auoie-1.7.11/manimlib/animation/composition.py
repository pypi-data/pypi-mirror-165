...
class AnimationGroup(Animation):
    ...
    def __init__(self, *animations: Animation, **kwargs):
        ...
        if self.group is None:
            self.group = Group(*remove_list_redundancies([anim.mobject for anim in animations]))
        self.init_run_time()
...
class LaggedStartMap(LaggedStart):
    ...
    def __init__(
        self, AnimationClass: type, mobject: Mobject, arg_creator: Callable[[Mobject], tuple] | None = None, **kwargs
    ):
        args_list = []
