...
class Mobject(object):
    ...
    @property
    # Although it is incorrect to say that the return type is T,
    # it helps with the code editor giving autocomplete for the methods on the animation builder
    def animate(self: T) -> T:
    ...
    def become(self, mobject: Mobject):
        ...
        # This line makes the Mobject method always_redraw not work
        return self
    ...
    def add_updater(
        self: T,
        update_function: Callable[[T, float], None | T] | Callable[[T], None | T],
        index: int | None = None,
