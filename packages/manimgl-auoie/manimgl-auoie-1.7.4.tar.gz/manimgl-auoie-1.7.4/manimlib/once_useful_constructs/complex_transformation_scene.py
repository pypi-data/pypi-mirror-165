...
class ComplexTransformationScene(Scene):
    ...
    def play(self, *animations, **kwargs):
        Scene.play(self, *list(animations) + list(map(Animation, self.foreground_mobjects)), **kwargs)
    ...
    def apply_complex_homotopy(self, complex_homotopy, added_anims=[], **kwargs):
        ...
        self.play(ComplexHomotopy(complex_homotopy, transformer, **transform_kwargs), *added_anims)
