...
def straight_path(start_points: np.ndarray, end_points: np.ndarray, alpha: float) -> np.ndarray:
    """
...
def path_along_arc(arc_angle: float, axis: np.ndarray = OUT) -> Callable[[np.ndarray, np.ndarray, float], np.ndarray]:
    """
