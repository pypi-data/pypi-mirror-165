...
class CountInTernary(PowerCounter):
    CONFIG = {"base": 3, "dot_configuration_height": 1, "ones_configuration_location": UP + 4 * RIGHT}
...
class CountInBinaryTo256(PowerCounter):
    CONFIG = {"base": 2, "dot_configuration_height": 1, "ones_configuration_location": UP + 5 * RIGHT}
...
class FactorialBase(CountingScene):
    CONFIG = {"dot_configuration_height": 1, "ones_configuration_location": UP + 4 * RIGHT}
