...
def test_dict_to_user_profile_with_primary_app():
    user_dict = {"primary_app": "chalo", **user_profile_dict}
    user_profile = UserProfile.from_dict(user_dict)
    assert user_profile.primary_app == "chalo"
...
def test_user_profile_with_primary_app_to_dict():
    user_profile = UserProfile.from_dict(user_dict)
    user_profile.primary_app = "chalo"
    assert user_profile.to_dict()["primary_app"] == "chalo"
