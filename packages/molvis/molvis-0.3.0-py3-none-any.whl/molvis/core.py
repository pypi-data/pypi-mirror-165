...
class Atom():
    ...
    def __init__(self, style, colour, opacity, serial) -> None:
    ...
    def atom_opacities(self, atom_opacities: list):
        ...
        if not isinstance(atom_opacities, (list, float)):
            ...
            self._atom_opacities = [
                atom_opacities for it in range(self.n_atoms)
            ]
...
class HtmlPage():
    """
    Objct defining a single html file/page with given elements
