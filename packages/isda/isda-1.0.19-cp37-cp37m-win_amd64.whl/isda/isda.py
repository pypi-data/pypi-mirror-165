...
def compute_isda_upfront(trade_date, effective_date, maturity_date, value_date, accrual_start_date, recovery_rate, coupon_rate, notional, is_buy_protection, swap_rates, swap_tenors, par_spread, is_rofr, holiday_filename, swap_floating_day_count_convention, swap_fixed_day_count_convention, swap_fixed_payment_frequency, swap_floating_payment_frequency, verbose):
    return _isda.compute_isda_upfront(trade_date, effective_date, maturity_date, value_date, accrual_start_date, recovery_rate, coupon_rate, notional, is_buy_protection, swap_rates, swap_tenors, par_spread, is_rofr, holiday_filename, swap_floating_day_count_convention, swap_fixed_day_count_convention, swap_fixed_payment_frequency, swap_floating_payment_frequency, verbose)
