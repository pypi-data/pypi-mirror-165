...
config_result = []
config_result.append(bool(toml_config["APP"]["DEBUG"]))
...
def find_requirements_file():
        ...
        with open(req_file) as f:
            ...
            for line in lines:
                if "-r " in line:
                    ...
                    if next_req == 0:
                        raise FileNotFoundError("Ambiguous result - "
    ...
    if final == 1:
        ...
        logger.info(f"Found requirement file: {filename}")
        return result
    elif final == -1:
