...
class RasterGroup:
    ...
    def tiles_inflated(self, buffer_size, original_extent=False):
        """
        ...
        if self.stacked:
            ...
            generators = [r.tiles_inflated(buffer_size, original_extent) for r in self]
        ...
        if self.adjacent:
            for raster in self:
                for inflated_tile in raster.inflated_tiles(
                    buffer_size, original_extent
                ):
                    yield inflated_tile
