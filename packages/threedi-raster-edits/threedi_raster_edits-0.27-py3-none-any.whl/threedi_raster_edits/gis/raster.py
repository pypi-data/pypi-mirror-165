...
class Raster:
    ...
    def read_point(self, point: ogr.Geometry, location=False):
        """
        Samples points, based on 'raster'.
        input is an ogr geometry
        return a dictionary with sampled values.
        params:
            point: location to be sampled.
            location: if true, the indices of the array are returned.
        """
        # inverse
        ...
        try:
            ...
            return self.nodata_value  # Point outside raster?
