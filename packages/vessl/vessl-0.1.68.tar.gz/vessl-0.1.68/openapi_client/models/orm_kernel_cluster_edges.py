...
class OrmKernelClusterEdges(object):
    ...
    def __init__(self, default_storage=None, kernel_cluster_nodes=None, kernel_cluster_storages=None, kernel_cluster_workloads=None, kernel_resource_specs=None, organization_kernel_clusters=None, region=None, local_vars_configuration=None):  # noqa: E501
