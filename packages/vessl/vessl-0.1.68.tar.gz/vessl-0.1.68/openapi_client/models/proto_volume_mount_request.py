...
class ProtoVolumeMountRequest(object):
    ...
    def __init__(self, archive_file=None, code=None, dataset=None, dataset_version=None, empty_dir=None, model_volume=None, mount_path=None, mount_type=None, on_premise=None, output=None, readonly=None, source_type=None, volume=None, local_vars_configuration=None):  # noqa: E501
