...
class OrmKernelCluster(object):
    ...
    def __init__(self, created_dt=None, default_storage_id=None, edges=None, id=None, immutable_slug=None, is_vessl_managed=None, kubernetes_service_type=None, name=None, provider=None, region_id=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
