...
class ResponseDatasetInfo(object):
    ...
    def __init__(self, created_dt=None, description=None, id=None, is_public=None, is_read_only=None, is_version_enabled=None, name=None, organization=None, source=None, updated_dt=None, volume_id=None, local_vars_configuration=None):  # noqa: E501
