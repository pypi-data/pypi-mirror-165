...
class ResponseOrganizationInfo(object):
    ...
    def __init__(self, auto_top_up_charge_amount=None, auto_top_up_enabled=None, auto_top_up_trigger_amount=None, aws_external_id=None, created_dt=None, credit_balance=None, description=None, display_name=None, id=None, is_public=None, name=None, pricing_plan=None, primary_owner_id=None, stripe_customer_id=None, stripe_subscription_id=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
