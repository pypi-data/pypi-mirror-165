...
class OrmDataset(object):
    ...
    def __init__(self, created_dt=None, dataset_organization=None, dataset_version_volume=None, dataset_volume=None, description=None, edges=None, id=None, immutable_slug=None, is_public=None, is_version_enabled=None, name=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
