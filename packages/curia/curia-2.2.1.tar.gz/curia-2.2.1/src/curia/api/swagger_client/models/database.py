...
class Database(object):
    ...
    def __init__(self, id=None, name=None, description=None, location=None, last_synced_at=None, organization_id=None, tables=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, archived_at=None, version=None):  # noqa: E501
