    ...
    `}},{kind:"method",key:"firstUpdated",value:function(e){v(y(i.prototype),"firstUpdated",this).call(this,e),(0,a.O)()}},{kind:"method",key:"_computeDeviceName",value:function(e,t){const i=e.find((e=>e.id===t));return i?(0,o.jL)(i,this.hass):`<${this.hass.localize("ui.panel.config.integrations.config_entry.unknown_via_device")}>`}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,r.iv`
      ...
      `;const u=(0,m.jL)(f,this.hass),v=this._integrations(f,this.entries),y=this._entities(this.deviceId,this.entities),g=this._entitiesByCategory(y),b=this._batteryEntity(y),w=this._batteryChargingEntity(y),k=b?this.hass.states[b.entity_id]:void 0,_=k&&"binary_sensor"===(0,l.N)(k),C=w?this.hass.states[w.entity_id]:void 0,$=this._computeArea(this.areas,f),x=[],D=[...this._deviceActions||[]];Array.isArray(this._diagnosticDownloadLinks)&&D.push(...this._diagnosticDownloadLinks),this._deleteButtons&&D.push(...this._deleteButtons),D.sort(((e,t)=>"warning"===e.classes&&"warning"!==t.classes?1:"warning"!==e.classes&&"warning"===t.classes?-1:0));const A=D.shift();f.disabled_by&&x.push(t.dy`
          ...
          ${"user"===f.disabled_by?t.dy`
              ...
              `:""}
        `),this._renderIntegrationInfo(f,v,x);const z=(0,s.p)(this.hass,"automation")?t.dy`
          <ha-card outlined>
        ...
        `:"",S=(0,s.p)(this.hass,"scene")&&y.length?t.dy`
            <ha-card outlined>
              <h1 class="card-header">
