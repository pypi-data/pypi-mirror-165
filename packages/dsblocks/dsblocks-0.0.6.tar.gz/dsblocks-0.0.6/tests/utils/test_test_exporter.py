...
# %% auto 0
__all__ = ['nb_fn', 'tests', 'nb_processor', 'outputs_fn', 'outputs', 'nb_fn2', 'outputs2', 'to_output', 'test_to_output',
           'test_test_exporter', 'test_test_merger', 'test_test_merger_diff', 'test_write_test_nb',
           'test_export_nb_tests', 'test_export_nb_tests2', 'test_get_ipynb_paths', 'test_build_test_nb',
           'test_extract_outputs', 'test_extract_and_write_outputs', 'test_extract_and_write_outputs2', 'test_freeze',
           'test_write_frozen_nb', 'test_un_freeze', 'test_write_unfrozen_nb', 'test_store_frozen', 'test_freeze_all',
           'test_store_unfrozen', 'test_unfreeze_all']
...
def test_un_freeze ():
    ...
    nb_unfreezer = NBProcessor(nb_fn2, un_freeze, rm_directives=False)
