...
class DatabaseRates(Rates):
    ...
    def get_tool_rate(self, tool: Tool) -> str:
        ...
        # Remove the following when new version of NEMO comes out (4.3.0)
        html_rate = '<style>.tool-rates .media-heading { font-size: medium; font-weight: 500; } .tool-rates .media-heading { display: block; }</style>'
