...
* Installation:
        ...
        conda install -c bioconda "biobb_dna>=3.8.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_dna:3.8.1--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_dna:3.8.1--pyhdfd78af_0 <command>
