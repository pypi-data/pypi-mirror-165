...
class LoggedRequests:
    ...
    def get(self=None, url=None, params=None, **kwargs):
        ...
        self.logger.info(os.linesep + "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< GET Response:")
        ...
        self.logger.info("========================= GET DONE =========================" + os.linesep + os.linesep)
    ...
    def put(self=None, url=None, data=None, **kwargs):
        ...
        self.logger.info(os.linesep + "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< PUT Response:")
        self.logger.info(response)
    ...
    def delete(self=None, url=None, **kwargs):
        ...
        self.logger.info(os.linesep + "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< DELETE Response:")
        self.logger.info(response)
        ...
        self.logger.info("========================= DELETE DONE =========================" + os.linesep + os.linesep)
