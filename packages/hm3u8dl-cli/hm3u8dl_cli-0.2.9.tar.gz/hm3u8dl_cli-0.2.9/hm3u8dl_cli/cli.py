...
def main(argv=None):
    parser = ArgumentParser(
        prog=f"version {version.version} https://github.com/hecoter/hm3u8dl_cli",
    ...
    parser.add_argument("-merge_mode", default=3, help='1:二进制合并，2：二进制合并完成后用ffmpeg转码，3：用ffmpeg合并转码')
