...
def sum_all(DBASE,SUMMATION,R=RESCALE):
    ...
    DBASE : str or pandas.DataFrame
        Name of the database file/DataFrame that contains
        [filename, entropy and XY-center] of each datafile of 4D-STEM dataset.
    SUMMATION : stemdiff.const.summation object
        The summation object contains parameters for the summation.
        More information about the summation parameters => stemdiff.const.    
    R : int, optional, default=stemdiff.const.RESCALE
        ...
        * The optimal value of R is 4 ~ we use 4-fold upscaling.
...
def sum_4Dstem_datafiles(df,R=RESCALE, PSF=None, itr=None, imgsize=None):
    ...
    # Sum with deconvolution .................................................
        ...
        for index,datafile in df:
            ...
            arr = arr/np.max(arr)
            # Deconvolution
            arr = restoration.richardson_lucy(arr, psf, num_iter=itr)
...
def save_results(
    ...
    Nothing : None
        ...
        * Name of the 2D-diffractogram = *output*.png.
        * Name of the 1D-profile = *output*.txt.
    '''
    # Prepare filenames
