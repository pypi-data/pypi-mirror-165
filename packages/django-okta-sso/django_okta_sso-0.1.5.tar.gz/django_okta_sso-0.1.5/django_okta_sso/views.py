...
def login(request):
    ...
    response = render(request, "django_okta_sso/login.html", {"config": okta_config})
...
def callback(request):
    ...
    if "error" in request.GET:
        ...
        return HttpResponseRedirect(reverse("django_okta_sso:login"))
    ...
    if user is None:
        return redirect(reverse("django_okta_sso:login"))
