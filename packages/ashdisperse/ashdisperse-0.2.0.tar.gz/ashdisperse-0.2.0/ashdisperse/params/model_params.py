...
class ModelParameters:
    ...
    def describe(self):
        ...
        print(f"  Settling speed scale = {self.SettlingScale}")
        print(f"  Velocity ratio = {self.Velocity_ratio}")
        print(f"  concentration scale = {self.cScale}")
        print(f"  x and y scale = {self.xyScale}")
        print(f"  Lx = {self.Lx}")
        print(f"  Ly = {self.Ly}")
        print(f"  source flux scale = {self.QScale}")
        print(f"  Peclet number = {self.Peclet_number}")
        print(f"  Diffusion ratio = {self.Diffusion_ratio}")
        print("********************")
