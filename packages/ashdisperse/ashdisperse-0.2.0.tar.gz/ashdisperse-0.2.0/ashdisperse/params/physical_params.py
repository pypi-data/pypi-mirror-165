...
class PhysicalParameters:
    ...
    def describe(self):
        ...
        print(f"  Horizontal diffusion coefficient Kappa_h = {self.Kappa_h} m^2/s")
        print(f"  Vertical diffusion coefficient Kappa_v = {self.Kappa_v} m^2/s")
        print(f"  Gravitational acceleration g = {self.g} m/s^2")
        print(f"  Viscosity of air mu = {self.mu} kg/m/s")
        print("********************")
