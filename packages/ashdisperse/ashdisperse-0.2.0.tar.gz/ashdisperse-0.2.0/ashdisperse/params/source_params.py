...
class SourceParameters:
    ...
    def describe(self):
        ...
        print(f"  Mass eruption rate MER = {self.MER} kg/s")
        print(f"  Eruption duration = {self.duration} s")
        print(f"  Plume height H = {self.PlumeHeight} m")
        print(f"  Gaussian source radius = {self.radius} m")
        print(f"  Suzuki emission profile k-parameter = {self.Suzuki_k}")
        print(f"  Suzuki emission profile peak-parameter = {self.Suzuki_peak}")
        print("********************")
