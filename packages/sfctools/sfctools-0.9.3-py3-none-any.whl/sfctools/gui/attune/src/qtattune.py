...
class TransactionDesigner(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.checkBoxLabels.stateChanged.connect(self.check_label_state_changed)
...
"""
    ...
    def check_label_state_changed(self,int):
        ...
        try:
            ...
            #with open(folder + "./mainloop.py","w") as file:
                if self.mainloop_str == "" or overwrite:
                    ...
                    yes = self.ask_question('', "WARNING - You are about to create a fresh mainloop.py script. This could potentially overwrite previous versions.\nThis operation cannot be reverted. Continue?")
                    if not yes:
                        return
...
"""
    ...
    def cleanup_transaction_data(self,data):
        ...
        try:
            print("old_data",data)
            # data = dict(data)
            new_data = {"agents":{},"transactions":[],"box_positions":{}} # data.copy()
    ...
    def resizeEvent(self, event):
        ...
        # resize transaction
        w = 741
        h = 291 + max(0,self.frameGeometry().height()-985) - 80
        self.transactionView.setGeometry(30,670,w,h)

        self.label_17.setGeometry(810,self.frameGeometry().height()-150,131,91)
        self.radioButton.setGeometry(810,self.frameGeometry().height()-22-22,22,22)
        ...
        try:
            ...
            with open(filename, 'r') as stream:
                ...
                try:
                    ...
                    self.notify("Error retreiving the transaction data from the .mamba file. Aborting.\n"+str(e),title="Error")
...
\\begin{document}\n""" + df_latex   + "\n\\end{document}"
    ...
    def gen_tex_ics(self):
        ...
        try:
            ...
            pd.DataFrame(combined_sheets).to_excel("test.xlsx")
    ...
    def add_new(self):
        ...
        new_entry["shortname"] = \
            str(self.editShortname.text().lower())
