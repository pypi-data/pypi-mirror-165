...
+---------------------------+--------------------+------------------------------------------------------------------+
    ...
    def __init__(self, owner,data=None,tot_dict=None,total_spendings=0.0):
        ...
        if self.data is None or self.tot_dict is None:
            self.restore()
    ...
    def reset(self):
        ...
        """
        self.last = IncomeStatement(owner=self.owner,data=self.data.copy(),tot_dict=self.tot_dict.copy(),total_spendings=self.total_spendings) # < TODO test this properly
        self.restore()
