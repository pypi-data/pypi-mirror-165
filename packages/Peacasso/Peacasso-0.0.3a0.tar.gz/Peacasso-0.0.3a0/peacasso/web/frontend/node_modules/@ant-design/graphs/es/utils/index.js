...
import { defaultMinimapCfg, defaultNodeSize, defaultCardStyle, prefix, defaultFlowGraphAnchorPoints, } from '../constants';
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    createLoading(itemModel, fetchLoading);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    createLoading(model, fetchLoading);
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    createLoading(item.getModel(), fetchLoading);
                    return [4 /*yield*/, asyncData(item.getModel())];
                case 3:
...
/** 开启加载动画， 不支持同时存在多个 */
export var createLoading = function (node, fetchLoading) {
