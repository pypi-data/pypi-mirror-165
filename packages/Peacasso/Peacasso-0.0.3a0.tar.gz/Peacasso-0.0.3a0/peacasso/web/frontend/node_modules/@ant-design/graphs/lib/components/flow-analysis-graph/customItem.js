...
var registerIndicatorGeometries = function () {
    ...
    g6_1.default.registerNode('indicator-card', {
        ...
        draw: function (cfg, group) {
            var _a, _b, _c, _d;
            if (cfg === void 0) { cfg = {}; }
            var _e = cfg.value, value = _e === void 0 ? {} : _e, nodeCfg = cfg.nodeCfg, markerCfg = cfg.markerCfg;
            var _f = nodeCfg, titleCfg = _f.title, itemsCfg = _f.items, _g = _f.label, label = _g === void 0 ? {} : _g, style = _f.style, _h = _f.padding, padding = _h === void 0 ? 0 : _h, badge = _f.badge, autoWidth = _f.autoWidth, customContent = _f.customContent;
            ...
            var _j = titleCfg !== null && titleCfg !== void 0 ? titleCfg : {}, titleStyle = _j.style, titleContainerStyle = _j.containerStyle, _k = _j.autoEllipsis, autoEllipsis = _k === void 0 ? true : _k;
            var _l = itemsCfg !== null && itemsCfg !== void 0 ? itemsCfg : {}, itemStyle = _l.style, itemContainerStyle = _l.containerStyle, layout = _l.layout, _m = _l.itemSpacing, itemSpacing = _m === void 0 ? 4 : _m, sort = _l.sort, _o = _l.padding, itemPadding = _o === void 0 ? [6, 0, 0] : _o;
            var itemPaddingArray = (0, utils_1.getCssPadding)(itemPadding);
            var _p = value, title = _p.title, items = _p.items;
            ...
            if (markerCfg) {
                ...
                var _q = shape.getBBox(), shapeWidth_1 = _q.width, shapeHeight_1 = _q.height;
                var _r = typeof markerCfg === 'function'
                    ? markerCfg(__assign(__assign({}, cfg), { graphData: __assign({}, (_d = (0, global_1.getGlobalInstance)(cfg._graphId)) === null || _d === void 0 ? void 0 : _d.get('eventData').getData()) }), group)
                    : markerCfg, show = _r.show, _s = _r.position, position = _s === void 0 ? 'right' : _s, collapsed = _r.collapsed, markerStyle = _r.style;
