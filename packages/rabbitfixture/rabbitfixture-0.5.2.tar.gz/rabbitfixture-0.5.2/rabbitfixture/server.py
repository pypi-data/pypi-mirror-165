...
class RabbitServerRunner(Fixture):
    ...
    def _signal(self, code):
        ...
        # 14.04 and later /usr/sbin/rabbitmq-server is a shell script
        # wrapper that spawns the actual Erlang runtime sub-process which is
        # what actually does the work and listens for connections.
        try:
