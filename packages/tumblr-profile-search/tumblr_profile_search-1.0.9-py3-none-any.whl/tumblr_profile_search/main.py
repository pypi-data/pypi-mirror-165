...
def profile_search(
    ...
    """
    It takes a name as an input, and returns a dictionary of the profiles that match the name
    ...
    :return: the users, urls, images, descriptions and the dictionary of the profiles.
    """
