...
#   timestamp: 2022-08-29T11:20:52+00:00
...
class ManualTrigger(BaseModel):
    """
    +usage=Trigger the job on creation or manually later
    """
...
class ScheduledTrigger(BaseModel):
    """
    +usage=Run the job on a schedule
    """
...
class Job(BaseModel):
    ...
    name: constr(regex=r"^[a-z0-9-]{1,64}$") = Field(
    ...
    trigger: Union[ManualTrigger, ScheduledTrigger] = Field(..., description="+sort=4")
    count: int = Field(
        1,
        description="+label=Count\n+usage=Number of job instances you want to run.\n+icon=fa-clone\n+sort=5",
    )
