...
class CorpUserAppearanceSettingsClass(DictWrapper):
    ...
    def showSimplifiedHomepage(self) -> Union[None, bool]:
        """Getter: Flag whether the user should see a homepage with only datasets, charts & dashboards. Intended for users
    ...
    def showSimplifiedHomepage(self, value: Union[None, bool]) -> None:
        """Setter: Flag whether the user should see a homepage with only datasets, charts & dashboards. Intended for users
    who have less operational use cases for the datahub tool."""
