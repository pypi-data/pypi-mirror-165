...
class Binomial(Distribution):
    ...
    def plot_histogram(self):
        ...
        """
        plt.hist(self.data)
        plt.title('Histogram of Binomial Data')
        plt.xlabel('data')
        plt.ylabel('count')
    ...
    def pdf(self, k):
        ...
        """
        initial_value = math.factorial(self.n)/(math.factorial(k)*math.factorial(self.n-k))
        pdf = initial_value * math.pow(self.p, k) * (math.pow((1-self.p),(self.n-k)))
        return pdf
    ...
    def __repr__(self):
        ...
        self.mean = self.calculate_mean()
        self.stdev = self.calculate_stdev()
        return f"mean: {self.mean}, std_deviation: {self.stdev}, p: {self.p}, n: {self.n}"