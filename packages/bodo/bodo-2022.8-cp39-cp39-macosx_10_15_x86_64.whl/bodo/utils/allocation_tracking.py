...
def get_allocation_stats():
    bij__hosgg = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    dbul__nnel, abr__zxyr, hespp__xoml, ztr__nhcn = 0, 0, 0, 0
    for idssx__hjohe in bij__hosgg:
        dbul__nnel += idssx__hjohe[0]
        abr__zxyr += idssx__hjohe[1]
        hespp__xoml += idssx__hjohe[2]
        ztr__nhcn += idssx__hjohe[3]
    return dbul__nnel, abr__zxyr, hespp__xoml, ztr__nhcn
