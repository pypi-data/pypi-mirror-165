...
if pandas_version < (1, 4):
    ...
    def _set_noconvert_columns(self):
        ...
        hibm__uqvza = {mtm__ejbo: xmgi__bvhka for xmgi__bvhka, mtm__ejbo in
            enumerate(self.orig_names)}
        kaipy__nwhzi = [hibm__uqvza[mtm__ejbo] for mtm__ejbo in self.names]
        vhlic__qfib = self._set_noconvert_dtype_columns(kaipy__nwhzi, self.
            names)
        for dzm__bioj in vhlic__qfib:
            self._reader.set_noconvert(dzm__bioj)
