...
def get_thread_pool(worker_cpu_ratio, worker_count=None, os_container=None):
    # type: (int, Optional[int], Optional[OSContainer]) -> Tuple[int, int, concurrent.futures.ThreadPoolExecutor]
    ...
    return pool_size, cpu_count, concurrent.futures.ThreadPoolExecutor(pool_size)
