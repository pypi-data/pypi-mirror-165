...
setuptools.setup(
    ...
    install_requires=[
        ...
        "websocket-client>=0.55.0,<1.4.0",  # the version 1.4.0 is broken now (24-Aug-2022) https://github.com/websocket-client/websocket-client/actions/workflows/build.yml
        "requests>=2.18.4",
