...
class FileUploadManager(object):
    ...
    def _initiate_upload(self, critical, estimated_size, uploader, **kwargs):
        ...
        future._critical = critical
        future._monitor = monitor
        self.upload_results.append(future)

    def all_done(self):
        # type: () -> bool
        return all(future.done() for future in self.upload_results)
    ...
    def remaining_data(self):
        ...
        total_size = 0
        for future in self.upload_results:
            monitor = future._monitor
    ...
    def remaining_uploads(self):
        # type: () -> int
        status_list = [future.done() for future in self.upload_results]
