...
class RoleGroup(models.Model):
    ...
    parent_name = models.CharField(verbose_name='用户组', max_length=32, blank=True, null=True, help_text='')
...
class Role(models.Model):
    ...
    parent_role = models.ForeignKey(RolePermission, verbose_name='父级角色ID', on_delete=models.DO_NOTHING, blank=True, null=True, help_text='')
    permission_id = models.CharField(verbose_name='权限ID', max_length=32, blank=True, null=True, help_text='')
    user_group_id = models.CharField(verbose_name='分组ID', max_length=32, blank=True, null=True, help_text='')
    description = models.CharField(verbose_name='描述', max_length=32, blank=True, null=True, help_text='')
...
class UserToGroup(models.Model):
    """ 11、User_Group 分组表 """
    id = models.IntegerField(verbose_name='ID', primary_key=True, auto_created=True, help_text='')
    user = models.IntegerField(verbose_name='用户ID', blank=True, null=True, )
    group = models.ForeignKey(RoleGroup, verbose_name='分组ID', blank=True, null=True, help_text='', on_delete=models.DO_NOTHING, )

    class Meta:
        db_table = 'role_user_to_group'
        verbose_name_plural = "用户 - 用户与角色映射表"
