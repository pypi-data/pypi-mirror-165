...
def _contrib_sign_ste(data=None, out=None, name=None, **kwargs):
    ...
    Defined in /work/mxnet/src/operator/contrib/stes_op.cc:L79
...
def adagrad_update(weight=None, grad=None, history=None, lr=_Null, epsilon=_Null, wd=_Null, rescale_grad=_Null, clip_gradient=_Null, out=None, name=None, **kwargs):
    ...
    Defined in /work/mxnet/src/operator/optimizer_op.cc:L908
...
def retain(data=None, indices=None, out=None, name=None, **kwargs):
    ...
    Defined in /work/mxnet/src/operator/tensor/sparse_retain.cc:L53
