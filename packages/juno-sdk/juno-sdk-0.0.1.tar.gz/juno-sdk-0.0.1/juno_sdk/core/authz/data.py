...
from juno_sdk.core import AccAddress, Coin, Coins
from juno_sdk.util.base import BaseTerraData
from juno_sdk.util.converter import to_isoformat
from juno_sdk.util.json import JSONSerializable
...
class Authorization(BaseTerraData):
    ...
    def from_amino(amino: dict) -> Authorization:
        from juno_sdk.util.parse_authorization import parse_authorization_amino

        return parse_authorization_amino(amino)

    @staticmethod
    def from_data(data: dict) -> Authorization:
        from juno_sdk.util.parse_authorization import parse_authorization

        return parse_authorization(data)

    @staticmethod
    def from_proto(proto: Any_pb) -> Authorization:
        from juno_sdk.util.parse_authorization import parse_authorization_proto

        return parse_authorization_proto(proto)

    @staticmethod
    def unpack_any(proto: Any_pb) -> Authorization:
        from juno_sdk.util.parse_authorization import parse_authorization_unpack_any
...
class SendAuthorization(Authorization):
    """Type of :class:`Authorization` for :class:`MsgSend<juno_sdk.core.bank.msgs.MsgSend>`,
