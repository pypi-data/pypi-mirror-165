...
from juno_sdk.core import Coins, Dec
from juno_sdk.core.deposit import Deposit
from juno_sdk.core.gov import Proposal, ProposalStatus, WeightedVoteOption
from juno_sdk.core.gov.data import Vote
    ...
    async def proposals(
        ...
        Args:
            options (dict, optional): dictionary containing options. Defaults to {}. you can use one or more below:
                {
                    "proposal_status": juno_sdk.core.gov.ProposalStatus (int)
