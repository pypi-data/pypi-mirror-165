...
from juno_sdk.core import AccAddress, Coins, Dec, Numeric, PublicKey
from juno_sdk.core.broadcast import (
    AsyncTxBroadcastResult,
    BlockTxBroadcastResult,
    SyncTxBroadcastResult,
)
from juno_sdk.core.fee import Fee
from juno_sdk.core.msg import Msg
from juno_sdk.core.tx import AuthInfo, SignerData, SignMode, Tx, TxBody, TxInfo
from juno_sdk.util.hash import hash_amino
    ...
    async def estimate_fee(
        ...
        if gas_prices:
            ...
            if options.fee_denoms:
                _fee_denoms = options.fee_denoms if options.fee_denoms else ["ujuno"]
