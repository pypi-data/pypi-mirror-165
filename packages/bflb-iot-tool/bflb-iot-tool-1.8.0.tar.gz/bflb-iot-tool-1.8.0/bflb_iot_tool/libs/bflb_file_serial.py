...
class FileSerial(object):
    ...
    def open_listen(self, dev_com, baudrate, file_path, chunk_size=4096, timeout=1):
        ...
        first_message = bytes.fromhex("F0 00 04 00 {} {} {} {}".format(hex_size[-2:],
                                                                       hex_size[-4:-2],
                                                                       hex_size[-6:-4],
                                                                       hex_size[-8:-6]))
            ...
            while True:
                ...
                if message:
                    ...
                    if recv_message == b"OK":
                        ...
                        middle_message = bytes.fromhex("F1 00 {} {} {}".format(low_middle_size,
                                                              hight_middle_size,
                                                              new_message))
...
if __name__ == "__main__":
    fs = FileSerial()
    fs.open_listen("/dev/ttyACM1", 2000000, "/home/tanjiaxi/git/bouffalo_dev_cube/chips/bl602/img_create_mcu/img_if.bin")
