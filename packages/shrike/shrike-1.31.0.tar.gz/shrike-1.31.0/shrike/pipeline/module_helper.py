...
class AMLModuleLoader:
    ...
    def load_module_from_registry(self, module_name, module_version, module_cache_key):
    ...
    def load_module_from_feed(self, module_name, module_version, module_cache_key):
    ...
    def load_module_from_workspace(
        self, module_name, module_version, module_cache_key, module_namespace
    ):
    ...
    def load_prod_module(
        ...
        if from_workspace:
            return self.load_module_from_workspace(
                module_name, module_version, module_cache_key, module_namespace
            )
        for i in self.loading_order:
            if i == "registry":
                loaded_module_class = self.load_module_from_registry(
                    module_name, module_version, module_cache_key
                )
            elif i == "feed":
                loaded_module_class = self.load_module_from_feed(
                    module_name, module_version, module_cache_key
                )
            elif i == "workspace":
                loaded_module_class = self.load_module_from_workspace(
                    module_name, module_version, module_cache_key, module_namespace
                )
            else:
                raise ValueError(
