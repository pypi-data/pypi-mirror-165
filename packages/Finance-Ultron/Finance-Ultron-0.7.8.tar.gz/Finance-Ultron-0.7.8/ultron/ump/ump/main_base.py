...
g_project_root = path.join(root_drive, 'abu')  ## fix me

g_project_data_dir = path.join(g_project_root, 'data')  ## fix me

g_project_data_dir = path.join(g_project_data_dir, 'cache')  ## fix me
...
class MainBase(Base):
    ...
    def __init__(self,
        ...
        if orders_pd is not None and 'profit_cg' not in orders_pd.columns:
            ...
            self.log_func(
                'you do better AbuMetricsBase.fit_metrics in orders_pd!!!!')
    ...
    def _fit_brust_min(self, brust_min):
        ...
        if self.cprs.shape[0] < 50:
            ...
            self.log_func('{}: cprs shape < 50!'.format(
    ...
    def brust_min(self):
        ...
        factor_step = 3  #1 #if ABuEnv._g_enable_example_env_ipython else 3
    ...
    def dump_file_fn(self):
        ...
        return os.path.join(g_project_data_dir, unique_ump_name)
