...
class Bert4TriggerFunction(BaseFunction):
    def __init__(self):
        super().__init__()
...
class Bert4Trigger(Bert4TriggerFunction, nn.Module):
    def __init__(
            self,
            label_size,
            embedding_size=768,
...
class Bert4TriggerParallel(nn.DataParallel, Bert4TriggerFunction):
