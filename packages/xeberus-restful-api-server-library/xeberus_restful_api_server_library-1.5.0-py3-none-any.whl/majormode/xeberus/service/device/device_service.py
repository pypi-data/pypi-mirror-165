...
class DeviceService(BaseRdbmsService):
    ...
    def __activate_device_app(
        ...
        @param device_app: The client application to activate.  The object
            ...
            - `device_id: uuid.UUID` (required): The identification of the device
              which the client application needs to be activated.
    ...
    def __get_device_app(
        ...
        @return: An object containing the following attributes:
            ...
            - `device_id: uuid.UUID` (required): The identification of the mobile
              device which the client application is installed on.
...
.
    ...
    def verify_token(
        ...
        @param device_app: An object representing a client application
            ...
            - `device_id: uuid.UUID`: The identification of the mobile device that
              sends the token.
