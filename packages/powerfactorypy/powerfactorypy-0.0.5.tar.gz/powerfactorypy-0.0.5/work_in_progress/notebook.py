...
# %%
pf_cases = powerfactorypy.PFCaseStudies(app)
pf_cases.parameter_values = {
    "p HV load":[1, 2, 3, 4, 1, 2, 3, 4,],
...
pf_cases.parent_folder_operation_scenarios = r"Network Model\Operation Scenarios\test_case_studies"
