...
def generate_feature_weight(
    ...
    try:
        possible_matches_index = list(spind.query(row["geometry"]))
    ...
    if possible_matches_index:
        ...
        if len(precise_matches) != 0:
            ...
            res_intersection = row["geometry"].overlay(
...
def generate_feature_weight2(
    ...
    """
    hru_area = row["geometry"].area
    multipoly = _quadrat_cut_geometry(row["geometry"], quadrat_width=quadrat_width)
    geoms = set()
