...
_SHELLLAYERS = DESCRIPTOR.enum_types_by_name['ShellLayers']
...
_FIELDDEFINITION = DESCRIPTOR.message_types_by_name['FieldDefinition']
_DIMENSION = DESCRIPTOR.message_types_by_name['Dimension']
_DIMENSIONALITY = DESCRIPTOR.message_types_by_name['Dimensionality']
_UNITPARSEBYSYMBOL = DESCRIPTOR.message_types_by_name['UnitParseBySymbol']
_UNIT = DESCRIPTOR.message_types_by_name['Unit']
_LISTQUANTITYTYPES = DESCRIPTOR.message_types_by_name['ListQuantityTypes']
_FIELDDEFINITIONDATA = DESCRIPTOR.message_types_by_name['FieldDefinitionData']
_FIELDDEFINITIONUPDATEREQUEST = DESCRIPTOR.message_types_by_name['FieldDefinitionUpdateRequest']
...
ListQuantityTypes = _reflection.GeneratedProtocolMessageType('ListQuantityTypes', (_message.Message,), {
  'DESCRIPTOR' : _LISTQUANTITYTYPES,
  '__module__' : 'field_definition_pb2'
  # @@protoc_insertion_point(class_scope:ansys.api.dpf.field_definition.v0.ListQuantityTypes)
  })
_sym_db.RegisterMessage(ListQuantityTypes)
...
_FIELDDEFINITIONSERVICE = DESCRIPTOR.services_by_name['FieldDefinitionService']
