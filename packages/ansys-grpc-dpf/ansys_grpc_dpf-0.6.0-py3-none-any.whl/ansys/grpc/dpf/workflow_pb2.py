...
_WORKFLOWFROMINTERNALREGISTRYREQUEST = DESCRIPTOR.message_types_by_name['WorkflowFromInternalRegistryRequest']
_UPDATECONNECTIONREQUEST = DESCRIPTOR.message_types_by_name['UpdateConnectionRequest']
_OPERATORNAMING = DESCRIPTOR.message_types_by_name['OperatorNaming']
_UPDATEPINNAMESREQUEST = DESCRIPTOR.message_types_by_name['UpdatePinNamesRequest']
_WORKFLOWEVALUATIONREQUEST = DESCRIPTOR.message_types_by_name['WorkflowEvaluationRequest']
_WORKFLOWRESPONSE = DESCRIPTOR.message_types_by_name['WorkflowResponse']
_ADDOPERATORSREQUEST = DESCRIPTOR.message_types_by_name['AddOperatorsRequest']
_RECORDININTERNALREGISTRYREQUEST = DESCRIPTOR.message_types_by_name['RecordInInternalRegistryRequest']
_RECORDININTERNALREGISTRYRESPONSE = DESCRIPTOR.message_types_by_name['RecordInInternalRegistryResponse']
_EXPOSEDPINNAMES = DESCRIPTOR.message_types_by_name['ExposedPinNames']
_LISTRESPONSE = DESCRIPTOR.message_types_by_name['ListResponse']
_GETOPERATORREQUEST = DESCRIPTOR.message_types_by_name['GetOperatorRequest']
_GETOPERATORRESPONSE = DESCRIPTOR.message_types_by_name['GetOperatorResponse']
_INPUTTOOUTPUTCHAINREQUEST = DESCRIPTOR.message_types_by_name['InputToOutputChainRequest']
...
_REMOTECOPYREQUEST = DESCRIPTOR.message_types_by_name['RemoteCopyRequest']
