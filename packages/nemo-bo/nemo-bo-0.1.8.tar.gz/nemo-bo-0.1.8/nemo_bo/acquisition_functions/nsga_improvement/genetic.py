    ...
    def _initialize_infill(self):
        ...
        if self.problem.variables.num_cat_var > 0:
            for individual_idx, individual in enumerate(pop):
                ...
                # By euclidean distance, converts to the closest actual descriptors for categorical variables
                X_temp = self.problem.variables.categorical_values_euc(X_temp.reshape(1, -1))

                # Re-applies the min-max normalisation of the X values according to the defined variables' lower and
                # upper bounds
