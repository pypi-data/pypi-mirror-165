...
class BigQueryExecutor:
    ...
    def initiate_table(self,
        ...
        Parameters:
            ...
            require_partition_filter (bool): Specify whether querying the table would require a partition filter. Defaults to False.
            clustering (list): List of clustering fields. Defaults to None.
        
        Note:
            partitioning and clustering require reinitialisation of the table (existing table won't be patched)
        """
