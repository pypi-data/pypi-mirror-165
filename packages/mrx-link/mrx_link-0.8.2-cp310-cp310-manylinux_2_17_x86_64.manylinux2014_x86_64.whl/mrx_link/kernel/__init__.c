...
{
    "distutils": {
        "name": "mrx_link.kernel.__init__",
        "sources": [
            "mrx_link/kernel/__init__.py"
        ]
    },
    "module_name": "mrx_link.kernel.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__mrx_link__kernel____init__
#define __PYX_HAVE_API__mrx_link__kernel____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "mrx_link.kernel.__init__" */
#if !CYTHON_USE_MODULE_STATE
#endif
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "mrx_link.kernel.__init__"
extern int __pyx_module_is_main_mrx_link__kernel____init__;
int __pyx_module_is_main_mrx_link__kernel____init__ = 0;

/* Implementation of "mrx_link.kernel.__init__" */
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_u_kernel);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_u_kernel);
...
#define __pyx_n_u_kernel __pyx_mstate_global->__pyx_n_u_kernel
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {0, __pyx_k_kernel, sizeof(__pyx_k_kernel), 0, 1, 0, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitGlobals(void) {
  ...
  if (__Pyx_InitString(__pyx_string_tab[2], &__pyx_n_u_kernel) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
...
__Pyx_PyMODINIT_FUNC init__init__(void) { initkernel(); }
#endif
__Pyx_PyMODINIT_FUNC initkernel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_kernel(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_kernel(); }
#endif
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_mrx_link__kernel____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib("mrx_link", __pyx_n_u_kernel) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "mrx_link.kernel")) {
      if (unlikely((PyDict_SetItemString(modules, "mrx_link.kernel", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init mrx_link.kernel.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_COMPILING_IN_LIMITED_API
    Py_CLEAR(__pyx_m);
    #endif
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init mrx_link.kernel.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
