...
) -> Optional[Union[AnalysisStepData, ForbiddenError, NotFoundError]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[AnalysisStepData, ForbiddenError, NotFoundError]]:
    return Response(
...
def sync(
    *,
    ...
    """ Patch a piece of analysis data """
