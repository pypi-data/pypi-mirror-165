...
class FileLifecycleApi(object):
    ...
    def delete_category(self, body, **kwargs):  # noqa: E501
        """delete_category  # noqa: E501

        Delete a file lifecycle category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_category(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_category_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_category_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def delete_category_with_http_info(self, body, **kwargs):  # noqa: E501
        """delete_category  # noqa: E501

        Delete a file lifecycle category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_category_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `delete_category`")  # noqa: E501
    ...
    def get_flc_data(self, body, **kwargs):  # noqa: E501
        """get_flc_data  # noqa: E501

        get flc data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flc_data(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Body32 body: The resources_str is json string in the format:{chart_name:{name:<name>,type:<type>}} (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_flc_data_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.get_flc_data_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def get_flc_data_with_http_info(self, body, **kwargs):  # noqa: E501
        """get_flc_data  # noqa: E501

        get flc data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flc_data_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `get_flc_data`")  # noqa: E501
    ...
    def rename_category(self, body, **kwargs):  # noqa: E501
        """rename_category  # noqa: E501

        Rename an existing file lifecycle category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rename_category(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rename_category_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.rename_category_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def rename_category_with_http_info(self, body, **kwargs):  # noqa: E501
        """rename_category  # noqa: E501

        Rename an existing file lifecycle category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rename_category_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `rename_category`")  # noqa: E501
    ...
    def update_category(self, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_category_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_category_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def update_category_with_http_info(self, body, **kwargs):  # noqa: E501
        """update_category  # noqa: E501

        Update an existing file lifecycle category to change its file extensions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_category_with_http_info(body, async_req=True)
        >>> result = thread.get()
