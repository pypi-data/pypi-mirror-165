...
class Body8(object):
    ...
    @property
    def imagename(self):
        """Gets the imagename of this Body8.  # noqa: E501


        :return: The imagename of this Body8.  # noqa: E501
        :rtype: str
        """
    ...
    def imagename(self, imagename):
        """Sets the imagename of this Body8.


        :param imagename: The imagename of this Body8.  # noqa: E501
        :type: str
        """
    ...
    def use_public_ip(self):
        """Gets the use_public_ip of this Body8.  # noqa: E501
        ...
        :return: The use_public_ip of this Body8.  # noqa: E501
        :rtype: str
        """
    ...
    def use_public_ip(self, use_public_ip):
        """Sets the use_public_ip of this Body8.

        If set to 'YES', the ZCS container will listen on VPSA's public IP address (only valid on VPSAs with a public IP address).  If set to 'NO', the container will listen on the same private IP address that is used for addressing the storage.  Optional (set to 'NO' by default).  # noqa: E501

        :param use_public_ip: The use_public_ip of this Body8.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start(self):
        """Gets the start of this Body8.  # noqa: E501
        ...
        :return: The start of this Body8.  # noqa: E501
        :rtype: str
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this Body8.

        If set to 'YES', the ZCS container will be started immediately after creation.  If 'NO', it will not be started. Required.  # noqa: E501

        :param start: The start of this Body8.  # noqa: E501
        :type: str
        """
    ...
    def volumes(self, volumes):
        """Sets the volumes of this Body8.

        [{\"name\":\"volume-00000001\",\"path\":\"/vol1\",\"access\":\"rw\"}, {\"name\":\"volume-00000002\",\"path\":\"/vol2\",\"access\":\"r\"}]  # noqa: E501

        :param volumes: The volumes of this Body8.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def ports(self):
        """Gets the ports of this Body8.  # noqa: E501

        The exposed ports.  # noqa: E501

        :return: The ports of this Body8.  # noqa: E501
        :rtype: list[str]
        """
        return self._ports
    ...
    def ports(self, ports):
        """Sets the ports of this Body8.

        The exposed ports.  # noqa: E501

        :param ports: The ports of this Body8.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def args(self):
        """Gets the args of this Body8.  # noqa: E501
        ...
        :return: The args of this Body8.  # noqa: E501
        :rtype: list[str]
        """
        return self._args
    ...
    @args.setter
    def args(self, args):
        """Sets the args of this Body8.

        A Python list of Python dictionaries that contain arguments to pass to the ZCS container entry point program or script as defined by \"entrypoint\".  If passed as a string, a conversion to a Python list via json.loads will be attempted.  Every list item should be a dictionary that contains one key, \"arg\", whose value is the argument to pass to the ZCS container.  For example, if the entrypoint is \"/usr/sbin/sshd\" these arguments will be passed to sshd.  e.g. ' [{\"arg\":\"-p 2222\"},{\"arg\":\"-f /etc/ssh/sshd_config\"}]'  # noqa: E501

        :param args: The args of this Body8.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def envvars(self):
        """Gets the envvars of this Body8.  # noqa: E501
        ...
        :return: The envvars of this Body8.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def envvars(self, envvars):
        """Sets the envvars of this Body8.

         [{\"variable\":\"IP_ADDRESS\",\"value\":\"172.20.125.100\"}, {\"variable\":\"USERNAME\",\"value\":\"zcs_container_01\"}, {\"variable\":\"PASSWORD\",\"value\":\"very_strong_password\"}]  # noqa: E501

        :param envvars: The envvars of this Body8.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def entrypoint(self):
        """Gets the entrypoint of this Body8.  # noqa: E501
        ...
        :return: The entrypoint of this Body8.  # noqa: E501
        :rtype: str
        """
    ...
    def entrypoint(self, entrypoint):
        """Sets the entrypoint of this Body8.

        The full path to the program or script inside the ZCS container to run when the container starts.  For exmple \"/usr/local/bin/entry.sh\"  # noqa: E501

        :param entrypoint: The entrypoint of this Body8.  # noqa: E501
        :type: str
        """
    ...
    @property
    def link(self):
        """Gets the link of this Body8.  # noqa: E501
        ...
        :return: The link of this Body8.  # noqa: E501
        :rtype: list[str]
        """
        return self._link
    ...
    @link.setter
    def link(self, link):
        """Sets the link of this Body8.

        A Python list that contain container identifiers that will be linked to the new container An example would be '[\"container-00000001\" , \"container-00000002\"]'  # noqa: E501

        :param link: The link of this Body8.  # noqa: E501
        :type: list[str]
        """
    ...
    def memorypoolname(self):
        """Gets the memorypoolname of this Body8.  # noqa: E501


        :return: The memorypoolname of this Body8.  # noqa: E501
        :rtype: str
        """
    ...
    def memorypoolname(self, memorypoolname):
        """Sets the memorypoolname of this Body8.


        :param memorypoolname: The memorypoolname of this Body8.  # noqa: E501
        :type: str
        """
