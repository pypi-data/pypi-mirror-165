...
class ZiosApi(object):
    ...
    def create_zios_zsnap(self, cloud_name, id, body, **kwargs):  # noqa: E501
        """create_zios_zsnap  # noqa: E501

        Create a ZIOS Zsnap.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_zios_zsnap(cloud_name, id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_zios_zsnap_with_http_info(cloud_name, id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_zios_zsnap_with_http_info(cloud_name, id, body, **kwargs)  # noqa: E501
            return data

    def create_zios_zsnap_with_http_info(self, cloud_name, id, body, **kwargs):  # noqa: E501
        """create_zios_zsnap  # noqa: E501

        Create a ZIOS Zsnap.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_zios_zsnap_with_http_info(cloud_name, id, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `create_zios_zsnap`")  # noqa: E501
