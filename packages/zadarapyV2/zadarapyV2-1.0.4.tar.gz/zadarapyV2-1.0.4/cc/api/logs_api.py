...
class LogsApi(object):
    ...
    def add_address_to_remote_rsyslog_server_list(self, cloud_name, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_address_to_remote_rsyslog_server_list(cloud_name, body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.add_address_to_remote_rsyslog_server_list_with_http_info(cloud_name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.add_address_to_remote_rsyslog_server_list_with_http_info(cloud_name, body, **kwargs)  # noqa: E501
            return data

    def add_address_to_remote_rsyslog_server_list_with_http_info(self, cloud_name, body, **kwargs):  # noqa: E501
        """add_address_to_remote_rsyslog_server_list  # noqa: E501

        Adds an address to the list of remote RSYSLOG server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_address_to_remote_rsyslog_server_list_with_http_info(cloud_name, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
            ...
            raise ValueError("Missing the required parameter `body` when calling `add_address_to_remote_rsyslog_server_list`")  # noqa: E501
    ...
    def delete_address_from_remote_rsyslog_server_list(self, cloud_name, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_address_from_remote_rsyslog_server_list(cloud_name, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_address_from_remote_rsyslog_server_list_with_http_info(cloud_name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_address_from_remote_rsyslog_server_list_with_http_info(cloud_name, body, **kwargs)  # noqa: E501
            return data

    def delete_address_from_remote_rsyslog_server_list_with_http_info(self, cloud_name, body, **kwargs):  # noqa: E501
        """delete_address_from_remote_rsyslog_server_list  # noqa: E501

        Deletes the supplied address from the list of remote RSYSLOG servers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_address_from_remote_rsyslog_server_list_with_http_info(cloud_name, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `delete_address_from_remote_rsyslog_server_list`")  # noqa: E501
