...
class RolesApi(object):
    ...
    def edit_role(self, id, body, **kwargs):  # noqa: E501
        """edit_role  # noqa: E501

        Edit role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_role(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.edit_role_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.edit_role_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def edit_role_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """edit_role  # noqa: E501

        Edit role.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_role_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `edit_role`")  # noqa: E501
