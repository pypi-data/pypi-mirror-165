...
class EC2Manager:
    ...
    def _get_json_from_s3(self, bucket_name, file_name):
        """
        ...
        try:
            ...
            self._logger.warning('backend state file does not exist.')
            return {}
    ...
    def _get_terraform_outputs(self):
        ...
        """
        state_data = self._get_json_from_s3(self._aws_backend_bucket, self._aws_backend_key)
    ...
    def _init_terraform(self):
        ...
        process = subprocess.run([
            ...
            f'-backend-config=region={self._aws_default_region}'
        ],
            env=os.environ,
