...
@click.option(
	...
	"harpiya_branch",
	default=None,
	help="Clone a particular branch of harpiya",
)
@click.option(
...
@click.option("--harpiya-path", default=None, help="path to harpiya repo")
...
@click.command("new-app", help="Create a new Harpiyaapplication under apps folder")
@click.option(
	"--no-git",
	is_flag=True,
	flag_value="--no-git",
	help="Do not initialize git repository for the app (available in Harpiyav14+)",
)
