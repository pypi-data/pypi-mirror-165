...
def is_version_upgrade(app="harpiya", bench_path=".", branch=None):
...
def get_current_harpiya_version(bench_path="."):
	try:
		return get_major_version(get_current_version("harpiya", bench_path=bench_path))
	except OSError:
		return 0
