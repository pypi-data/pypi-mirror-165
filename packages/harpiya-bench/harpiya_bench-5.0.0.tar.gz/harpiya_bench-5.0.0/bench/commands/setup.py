...
@click.group(help="Setup command group for enabling setting up a Harpiyaenvironment")
def setup():
	pass
...
@click.command("fonts", help="Add Harpiyafonts to system")
def setup_fonts():
...
@click.command(
	"production", help="Setup Harpiyaproduction environment for specific user"
)
@click.argument("user")
