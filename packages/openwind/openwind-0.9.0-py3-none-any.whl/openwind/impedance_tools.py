...
def plot_impedance(frequencies, impedance, Zc0=1, dbscale=True, figure=None,
                   label=None, modulus_only=False, remarkable_freqs =None, **kwargs):
    """
...
def match_freqs_with_notes(f_, concert_pitch_A=440, transposition = 0, display=False):
    """
    ...
    if(concert_pitch_A==415 or concert_pitch_A==392):
        # for historical tunings only use usual alterations
        notes = ['A','Bb','B','C','C#','D','Eb ','E','F','F#','G','G#/Ab ']
    else:
