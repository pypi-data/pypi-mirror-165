...
class FrequentialSolver:
    ...
    def __init__(self, instru_physics, frequencies, diffus_repr_var=False,
        ...
        self.use_rad1dof = use_rad1dof           # Additional dof for radiation ? Useful for modal
    ...
    def _convert_connector(self, connector, ends):
        ...
        #   return(FrequentialSource(connector, ends))
            ...
            elif isinstance(connector, RadiationPade) and self.use_rad1dof:
    ...
    def resonance_peaks(self, k=5):
        ...
        if(self.compute_method=='modal'):
            ...
            raise ValueError("Option not available for FEM and TMM computation methods. Consider solving with compute_method = 'modal'.")
    ...
    def evaluate_impedance_at(self, freqs):
        ...
        self.frequencies = self._check_frequencies(freqs, self.compute_method, self.frequencies)
        if(self.compute_method == 'modal'):
