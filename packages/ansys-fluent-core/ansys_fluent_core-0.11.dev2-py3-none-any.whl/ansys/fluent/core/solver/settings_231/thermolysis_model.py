...
class thermolysis_model(Group):
    ...
    """
    expression child of thermolysis_model.
    """
    user_defined_function: user_defined_function = user_defined_function
    """
    user_defined_function child of thermolysis_model.
    """
    ...
    """
    polynomial child of thermolysis_model.
    """
    real_gas_nist: real_gas_nist = real_gas_nist
    """
    real_gas_nist child of thermolysis_model.
    """
    rgp_table: rgp_table = rgp_table
    """
    rgp_table child of thermolysis_model.
    """
    combustion_mixture: combustion_mixture = combustion_mixture
    """
    combustion_mixture child of thermolysis_model.
    """
    ...
    """
    biaxial child of thermolysis_model.
    """
    cyl_orthotropic: cyl_orthotropic = cyl_orthotropic
    """
    cyl_orthotropic child of thermolysis_model.
    """
    ...
    """
    principal_axes_values child of thermolysis_model.
    """
    sutherland: sutherland = sutherland
    """
    sutherland child of thermolysis_model.
    """
    power_law: power_law = power_law
    """
    power_law child of thermolysis_model.
    """
    compressible_liquid: compressible_liquid = compressible_liquid
    """
    compressible_liquid child of thermolysis_model.
    """
    blottner_curve_fit: blottner_curve_fit = blottner_curve_fit
    """
    blottner_curve_fit child of thermolysis_model.
    """
    vibrational_modes: vibrational_modes = vibrational_modes
    """
    vibrational_modes child of thermolysis_model.
    """
    non_newtonian_power_law: non_newtonian_power_law = non_newtonian_power_law
    """
    non_newtonian_power_law child of thermolysis_model.
    """
    carreau: carreau = carreau
    """
    carreau child of thermolysis_model.
    """
    herschel_bulkley: herschel_bulkley = herschel_bulkley
    """
    herschel_bulkley child of thermolysis_model.
    """
    cross: cross = cross
    """
    cross child of thermolysis_model.
    """
    kinetics_diffusion_limited: kinetics_diffusion_limited = kinetics_diffusion_limited
    """
    kinetics_diffusion_limited child of thermolysis_model.
    """
    intrinsic_model: intrinsic_model = intrinsic_model
    """
    intrinsic_model child of thermolysis_model.
    """
    cbk: cbk = cbk
    """
    cbk child of thermolysis_model.
    """
