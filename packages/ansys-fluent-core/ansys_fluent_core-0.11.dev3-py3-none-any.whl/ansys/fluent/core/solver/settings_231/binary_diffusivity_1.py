...
class binary_diffusivity(Group):
    ...
    """
    real_gas_nist child of binary_diffusivity.
    """
    rgp_table: rgp_table = rgp_table
    """
    rgp_table child of binary_diffusivity.
    """
    combustion_mixture: combustion_mixture = combustion_mixture
    """
    combustion_mixture child of binary_diffusivity.
    """
    ...
    """
    biaxial child of binary_diffusivity.
    """
    cyl_orthotropic: cyl_orthotropic = cyl_orthotropic
    """
    cyl_orthotropic child of binary_diffusivity.
    """
    ...
    """
    principal_axes_values child of binary_diffusivity.
    """
    sutherland: sutherland = sutherland
    """
    sutherland child of binary_diffusivity.
    """
    power_law: power_law = power_law
    """
    power_law child of binary_diffusivity.
    """
    compressible_liquid: compressible_liquid = compressible_liquid
    """
    compressible_liquid child of binary_diffusivity.
    """
    blottner_curve_fit: blottner_curve_fit = blottner_curve_fit
    """
    blottner_curve_fit child of binary_diffusivity.
    """
    vibrational_modes: vibrational_modes = vibrational_modes
    """
    vibrational_modes child of binary_diffusivity.
    """
    non_newtonian_power_law: non_newtonian_power_law = non_newtonian_power_law
    """
    non_newtonian_power_law child of binary_diffusivity.
    """
    carreau: carreau = carreau
    """
    carreau child of binary_diffusivity.
    """
    herschel_bulkley: herschel_bulkley = herschel_bulkley
    """
    herschel_bulkley child of binary_diffusivity.
    """
    cross: cross = cross
    """
    cross child of binary_diffusivity.
    """
    kinetics_diffusion_limited: kinetics_diffusion_limited = kinetics_diffusion_limited
    """
    kinetics_diffusion_limited child of binary_diffusivity.
    """
    intrinsic_model: intrinsic_model = intrinsic_model
    """
    intrinsic_model child of binary_diffusivity.
    """
    cbk: cbk = cbk
    """
    cbk child of binary_diffusivity.
    """
    single_rate: single_rate = single_rate
    """
    single_rate child of binary_diffusivity.
    """
    secondary_rate: secondary_rate = secondary_rate
    """
    secondary_rate child of binary_diffusivity.
    """
