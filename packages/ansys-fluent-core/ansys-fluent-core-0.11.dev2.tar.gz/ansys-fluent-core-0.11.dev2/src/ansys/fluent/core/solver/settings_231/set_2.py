...
from .use_laplace_smoothing import use_laplace_smoothing
from .laplace_smoothing import laplace_smoothing
from .nfaces_as_weights_1 import nfaces_as_weights
from .use_face_area_as_weights import use_face_area_as_weights
...
class set(Group):
    ...
    child_names = \
        ['cell_function', 'load_distribution', 'merge',
         ...
         'origin', 'use_laplace_smoothing', 'laplace_smoothing',
         'nfaces_as_weights', 'use_face_area_as_weights', 'layering',
    ...
    origin child of set.
    """
    use_laplace_smoothing: use_laplace_smoothing = use_laplace_smoothing
    """
    use_laplace_smoothing child of set.
    """
    ...
    """
    use_face_area_as_weights: use_face_area_as_weights = use_face_area_as_weights
    """
    use_face_area_as_weights child of set.
    """
