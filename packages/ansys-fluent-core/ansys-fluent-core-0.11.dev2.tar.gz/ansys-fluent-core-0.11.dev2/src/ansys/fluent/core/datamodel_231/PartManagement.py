    ...
    class Mirror(PyNamedObjectContainer):
        ...
        class _Mirror(PyMenu):
            ...
            def __init__(self, service, rules, path):
                ...
                self.MirrorX = self.__class__.MirrorX(service, rules, path + [("MirrorX", "")])
                self.MirrorY = self.__class__.MirrorY(service, rules, path + [("MirrorY", "")])
                self.MirrorZ = self.__class__.MirrorZ(service, rules, path + [("MirrorZ", "")])
                self.Name = self.__class__.Name(service, rules, path + [("Name", "")])
            ...
            class MirrorX(PyParameter):
                """
                Parameter MirrorX of value type bool.
                """
                pass

            class MirrorY(PyParameter):
                """
                Parameter MirrorY of value type bool.
                """
                pass

            class MirrorZ(PyParameter):
                """
                Parameter MirrorZ of value type bool.
                """
                pass
