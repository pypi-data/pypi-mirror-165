...
class struct_youngs_modulus(Group):
    ...
    """
    expression child of struct_youngs_modulus.
    """
    ...
    """
    polynomial child of struct_youngs_modulus.
    """
    real_gas_nist: real_gas_nist = real_gas_nist
    """
    real_gas_nist child of struct_youngs_modulus.
    """
    rgp_table: rgp_table = rgp_table
    """
    rgp_table child of struct_youngs_modulus.
    """
    combustion_mixture: combustion_mixture = combustion_mixture
    """
    combustion_mixture child of struct_youngs_modulus.
    """
    ...
    """
    biaxial child of struct_youngs_modulus.
    """
    cyl_orthotropic: cyl_orthotropic = cyl_orthotropic
    """
    cyl_orthotropic child of struct_youngs_modulus.
    """
    ...
    """
    principal_axes_values child of struct_youngs_modulus.
    """
    sutherland: sutherland = sutherland
    """
    sutherland child of struct_youngs_modulus.
    """
    power_law: power_law = power_law
    """
    power_law child of struct_youngs_modulus.
    """
    compressible_liquid: compressible_liquid = compressible_liquid
    """
    compressible_liquid child of struct_youngs_modulus.
    """
    blottner_curve_fit: blottner_curve_fit = blottner_curve_fit
    """
    blottner_curve_fit child of struct_youngs_modulus.
    """
    vibrational_modes: vibrational_modes = vibrational_modes
    """
    vibrational_modes child of struct_youngs_modulus.
    """
    non_newtonian_power_law: non_newtonian_power_law = non_newtonian_power_law
    """
    non_newtonian_power_law child of struct_youngs_modulus.
    """
    carreau: carreau = carreau
    """
    carreau child of struct_youngs_modulus.
    """
    herschel_bulkley: herschel_bulkley = herschel_bulkley
    """
    herschel_bulkley child of struct_youngs_modulus.
    """
    cross: cross = cross
    """
    cross child of struct_youngs_modulus.
    """
    kinetics_diffusion_limited: kinetics_diffusion_limited = kinetics_diffusion_limited
    """
    kinetics_diffusion_limited child of struct_youngs_modulus.
    """
    intrinsic_model: intrinsic_model = intrinsic_model
    """
    intrinsic_model child of struct_youngs_modulus.
    """
    cbk: cbk = cbk
    """
    cbk child of struct_youngs_modulus.
    """
    single_rate: single_rate = single_rate
    """
    single_rate child of struct_youngs_modulus.
    """
    secondary_rate: secondary_rate = secondary_rate
    """
    secondary_rate child of struct_youngs_modulus.
    """
    film_averaged: film_averaged = film_averaged
    """
    film_averaged child of struct_youngs_modulus.
    """
    diffusion_controlled: diffusion_controlled = diffusion_controlled
    """
    diffusion_controlled child of struct_youngs_modulus.
    """
    convection_diffusion_controlled: convection_diffusion_controlled = convection_diffusion_controlled
    """
    convection_diffusion_controlled child of struct_youngs_modulus.
    """
    lewis_number: lewis_number = lewis_number
    """
    lewis_number child of struct_youngs_modulus.
    """
    mass_diffusivity: mass_diffusivity = mass_diffusivity
    """
    mass_diffusivity child of struct_youngs_modulus.
    """
    delta_eddington: delta_eddington = delta_eddington
    """
    delta_eddington child of struct_youngs_modulus.
    """
    two_competing_rates: two_competing_rates = two_competing_rates
    """
    two_competing_rates child of struct_youngs_modulus.
    """
    cpd_model: cpd_model = cpd_model
    """
    cpd_model child of struct_youngs_modulus.
    """
    multiple_surface_reactions: multiple_surface_reactions = multiple_surface_reactions
    """
    multiple_surface_reactions child of struct_youngs_modulus.
    """
    ...
    """
    orthotropic_structure_nu child of struct_youngs_modulus.
    """
    orthotropic_structure_te: orthotropic_structure_te = orthotropic_structure_te
    """
    orthotropic_structure_te child of struct_youngs_modulus.
    """
