...
from .mass_diffusivity_1 import mass_diffusivity
...
class fluid_child(Group):
    ...
    child_names = \
        ['species', 'reactions', 'reaction_mechs', 'density', 'specific_heat',
         ...
         'collision_cross_section', 'reference_temperature',
         ...
         'scattering_phase_function', 'therm_exp_coeff',
         'premix_unburnt_density', 'premix_unburnt_temp',
    ...
    """
    collision_cross_section child of fluid_child.
    """
