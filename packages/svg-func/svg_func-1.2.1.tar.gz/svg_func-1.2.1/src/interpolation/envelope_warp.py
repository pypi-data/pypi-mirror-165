...
if __name__ == "__main__":
    ...
    svg,xml = main(svgpath=r"C:\Users\25790\Downloads\x(2).svg",c_svg='<svg viewBox="0 0 184.95 57.76" xmlns="http://www.w3.org/2000/svg"><path d="m184.95 57.76-92.48-9-92.47 9v-57.76l92.47 9 92.48-9z"/></svg>',
