...
def svg_emd_loss(p_pred, p_target,
                 first_point_weight=False, return_matched_indices=False,mode=None,last_loss=None):
    ...
    if last_loss !=None:
        weights_l = ((last_loss-last_loss.min())/last_loss.max()*10+1)
        losses = losses * weights_l
