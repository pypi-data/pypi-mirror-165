...
This file defines a DatastreamUserCreated_TimeSeries and ancillary classes that assist in creating and managing timeseries data.

DatastreamUserCreated_TimeSeries is derived from the DSConnect class that manages the raw JSON query and response protocol for the API service.
"""
...
class DSTimeSeriesFrequencyConversion(IntEnum):
    ...
    ActualValue = 3 # The actual value for the requested start date will be returned for the same given date in the requested period will be returned.
...
class DSTimeSeriesDataInput:
    ...
    Values: An array of float values. Use None to represent NotANumber for non-trading days. Alternatively, if you set the DatastreamUserCreated_TimeSeries 
...
class DSTimeSeriesDateRange:
    ...
    ValuesCount: A count of the number of dates and values returned.
    ...
    the Dates and Values lists will always be null. Only the ValuesCount field will be set to reflect the number of datapoints available for each item. You need to 
...
class DSTimeSeriesUserObjectBase(DSUserObjectBase):
    ...
    FrequencyConversion: A DSTimeSeriesFrequencyConversion enum value specifying how to return values if a user request data at a lower frequency than the timeseries
                         data is supplied. See DSTimeSeriesFrequencyConversion for details.
    DateAlignment: A DSTimeSeriesCarryIndicator enum value specifying whether dates for certain frequencies should be returned as the start, middle or end date of 
                   the period. See DSTimeSeriesCarryIndicator for details.
...
class DatastreamUserCreated_TimeSeries(DSConnect):
    """
    DatastreamUserCreated_TimeSeries is the client class that manages the connection to the API server on your behalf.
    ...
    Example usage:
    # first logon with your credentials. Creating a DatastreamUserCreated_TimeSeries instance with your credentials automatically logs on for you 
    ...
    def __init__(self, config = None, username = None, password = None, proxies = None, sslCer = None):
        ...
        """
        super().__init__(config, username, password, proxies, sslCer)
    ...
    def __CheckKeyTimeseriesProperties(self, tsItem):
        ...
        if not isinstance(tsItem, DSTimeSeriesRequestObject):
           return 'DatastreamUserCreated_TimeSeries CreateItem or ModifyItem methods require a valid DSTimeSeriesRequestObject instance.'
    ...
    def GetAllItems(self):
        ...
        """
        try:
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetAllItems', 'GetAllItems requested')
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetAllItems', 'GetAllItems returned')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetAllItems', 'Exception occured.', exp)
            raise exp
       ...
       """
        try:
            ...
            if reqCheck is not None:
                ...
                DSUserObjectLogFuncs.LogError('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetItem', 'Error: ' + reqCheck)
                return resp
            
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetItem', 'Requesting ' + itemId)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetItem', itemId + ' returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetItem', 'Exception occured.', exp)
            raise exp
    ...
    def GetTimeseriesDateRange(self, startDate, endDate, frequency = DSUserObjectFrequency.Daily):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                resp.ResponseStatus = DSUserObjectResponseStatus.UserObjectFormatError
                resp.ErrorMessage = reqCheck
                DSUserObjectLogFuncs.LogError('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetTimeseriesDateRange', 'Error: ' + resp.ErrorMessage)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetTimeseriesDateRange', 'Requesting date range')
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetTimeseriesDateRange', 'GetTimeseriesDateRange returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.GetTimeseriesDateRange', 'Exception occured.', exp)
            raise exp
    ...
    def CreateItem(self, newItem, overWrite = False, skipItemReturn = False):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                resp.ResponseStatus = DSUserObjectResponseStatus.UserObjectFormatError
                resp.ErrorMessage = reqCheck
                DSUserObjectLogFuncs.LogError('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.CreateItem', 'Error: ' + reqCheck)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.CreateItem', 'Creating ' + newItem.Id)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            json_Response = self._get_json_Response(request_url, raw_request)
            decoded = self.__JsonResponseDecoder(json_Response, self.__TimeseriesResponseType.GetItemResponse)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.CreateItem', newItem.Id + ' returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.CreateItem', 'Exception occured.', exp)
            raise exp
    ...
    def UpdateItem(self, item, skipItemReturn = False):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                resp.ResponseStatus = DSUserObjectResponseStatus.UserObjectFormatError
                resp.ErrorMessage = reqCheck
                DSUserObjectLogFuncs.LogError('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.UpdateItem', 'Error: ' + reqCheck)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.UpdateItem', 'Updating ' + item.Id)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            json_Response = self._get_json_Response(request_url, raw_request)
            decoded = self.__JsonResponseDecoder(json_Response, self.__TimeseriesResponseType.GetItemResponse)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.UpdateItem', item.Id + ' returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.UpdateItem', 'Exception occured.', exp)
            raise exp
    ...
    def DeleteItem(self, itemId):
        ...
        try:
            ...
            if reqCheck is not None:
                ...
                resp.ResponseStatus = DSUserObjectResponseStatus.UserObjectFormatError
                resp.ErrorMessage = reqCheck
                DSUserObjectLogFuncs.LogError('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.DeleteItem', 'Error: ' + reqCheck)
                return resp

            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.DeleteItem', 'Deleting ' + itemId)
            self.Check_Token() # check and renew token if within 15 minutes of expiry
            ...
            json_Response = self._get_json_Response(request_url, raw_request)
            decoded = self.__JsonResponseDecoder(json_Response, self.__TimeseriesResponseType.GetItemResponse)
            DSUserObjectLogFuncs.LogDetail(DSUserObjectLogLevel.LogInfo, 'DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.DeleteItem', itemId + ' returned a response')
            return decoded
        except Exception as exp:
            DSUserObjectLogFuncs.LogException('DatastreamUserCreated_TimeSeries.py', 'DatastreamUserCreated_TimeSeries.DeleteItem', 'Exception occured.', exp)
            raise exp
