...
class DSUserObjectShareTypes(IntEnum):
    ...
    For all object types other than expressions, the share type is always PrivateUserGroup. PrivateUserGroup are items created by any Datastream ID 
    that shares a parent Datastream ID with your ID. Only children of the parent ID can access the user object.
