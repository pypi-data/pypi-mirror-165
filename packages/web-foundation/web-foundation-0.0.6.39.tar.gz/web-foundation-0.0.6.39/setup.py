...
setup(
    ...
    version='0.0.6.39',  # Start with a small number and increase it with every change you make
    ...
    extras_require={"aerich": "aerich==0.6.3", "prometheus": "prometheus-client==0.14.1"}
)
