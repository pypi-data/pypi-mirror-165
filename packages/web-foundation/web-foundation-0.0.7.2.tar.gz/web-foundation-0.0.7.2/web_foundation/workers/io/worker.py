...
from web_foundation.app.infrastructure.metrics.formatter import GenMetricFormatter, JsonMetricFormatter, MetricFormatter
...
from web_foundation.app.infrastructure.metrics.exporter import MetricExporter, Metric
...
class HttpServer(Worker, ApiMetricsMixin):
    ...
    metrics_exporters: Dict[GenMetricFormatter, MetricExporter]
    ...
    def _configure(self, sock: socket.socket = None, ext_router: ExtRouter = None,
                   mdw_manager: ApiMiddlewareManager = None,
                   metrics_exporters: Dict[GenMetricFormatter, MetricExporter] = None):  # type: ignore
        ...
        self.metrics_exporters = metrics_exporters if metrics_exporters else {}
        self.metrics_exporters.update({JsonMetricFormatter[Dict]: MetricExporter()})
