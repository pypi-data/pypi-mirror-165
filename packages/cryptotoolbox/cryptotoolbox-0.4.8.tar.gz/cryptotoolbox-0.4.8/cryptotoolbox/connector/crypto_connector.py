...
def fetch_crypto_daily_data(ssj=None, local_root_directory=None, daily_return_pkl_filename_suffix='_daily_returns.pkl', refetch_all=True,daily_crypto_starting_day='2012-01-01', daily_crypto_ending_day=None,ssj_against='USDT', exchange = None, saving =False):
    ...
    if refetch_all:
        ...
        print('Loading data')
        if exchange is None:
            day_url_request = 'https://min-api.cryptocompare.com/data/v2/histoday?fsym={}&tsym='+ssj_against+'&toTs={}&limit=2000'
        else :
            day_url_request = 'https://min-api.cryptocompare.com/data/v2/histoday?fsym={}&tsym='+ssj_against+'&e='+exchange+'&toTs={}&limit=2000'
