...
setup_kwargs = {
    'name': 'bdvr',
    'version': '0.1.0',
    'description': "customized report generated from blackduck reports that gives 'color coded vulnerabilities', and 'source paths' including 'direct' and 'indirect dependencies' details all in one report",
