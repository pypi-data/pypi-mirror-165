...
df_new = pd.concat([salepur_bhw, salepur_ga, salepur_tepl,salepur_old]).reset_index(drop=True)
...
salepurchase1 = pd.concat([salepur1_bhw, salepur1_ga, salepur1_tepl,salepur1_bhw_old]).reset_index(drop=True)
...
acknow = pd.concat([acknow_bhw, acknow_ga, acknow_tepl,acknow_bhw_old]).reset_index(drop=True)
