...
if __name__ == '__main__':
    ...
    try:
        ...
        from
        "prod2-generico"."prod2-generico".fifo a
        right join "prod2-generico"."prod2-generico".item b on
        a.itemc = b.code
        where
        b.code > 0
        ...
        where
            Vtype = 'PB')
        and a.TQty > 0 and REGEXP_COUNT(b.barcode , '^[0-9]+$') > 0
        group by
        b.Barcode
        """
        ...
        df_pref=pd.read_csv(r"C:\Users\Lenovo\Downloads\preferred_distributors.csv")
        ...
        df_new_1.to_csv(r"D:\acsv_files\warehouse_m_1\purchase_m+1_new_1.csv")
