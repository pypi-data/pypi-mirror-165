...
# In this dictionary goes all the immutable values you want to show up under hub.OPT.overrides
CONFIG = {
    "config": {
        "default": None,
        "help": "Load extra options from a configuration file onto hub.OPT.overrides",
    }
}
