...
Q_CONTROL_RESPONSE_NAME = getenv('CRYTON_CORE_Q_CONTROL_RESPONSE')
...
CPU_CORES = int(getenv('CRYTON_CORE_CPU_CORES', len(sched_getaffinity(0))))
EXECUTION_THREADS_PER_PROCESS = int(getenv('CRYTON_CORE_EXECUTION_THREADS_PER_PROCESS', 5))

RPC_TIMEOUT = int(getenv('CRYTON_CORE_RPC_TIMEOUT'))
