...
class Plan:
    def __init__(self, **kwargs):
        ...
        if plan_model_id:
            ...
            self.model = PlanModel.objects.create(**kwargs, plan=kwargs)
    ...
    def __create_evidence_dir(self) -> None:
        ...
        path = os.path.abspath(config.EVIDENCE_DIRECTORY + "/" + dir_name)
...
class PlanExecution:
    ...
    def __generate_evidence_dir(self) -> None:
        ...
        :return: None
        """
        # TODO: rework evidence structure, run > planEx (or worker)
        ...
        execution_evidence_dir = os.path.abspath("/tmp/run_{}/worker_{}"
                                                 .format(self.model.run_id, self.model.worker.name))
