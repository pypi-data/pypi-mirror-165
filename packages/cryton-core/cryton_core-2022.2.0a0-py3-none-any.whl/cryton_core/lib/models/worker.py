...
from cryton_core.lib.util import exceptions, states, util, constants
...
class Worker:
    ...
    def attack_q_name(self):
        worker_q_name = "cryton_worker.{}.attack.request".format(self.name)
        return worker_q_name

    @property
    def agent_q_name(self):
        worker_q_name = "cryton_worker.{}.agent.request".format(self.name)
        return worker_q_name

    @property
    def control_q_name(self):
        worker_q_name = "cryton_worker.{}.control.request".format(self.name)
        return worker_q_name
