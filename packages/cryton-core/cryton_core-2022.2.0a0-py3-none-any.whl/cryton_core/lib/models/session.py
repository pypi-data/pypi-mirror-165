...
from cryton_core.lib.util import exceptions, util, logger, constants
...
def create_session(plan_execution_id: Union[Type[int], int], session_id: str,
    ...
    return SessionModel.objects.create(plan_execution_id=plan_execution_id, name=session_name, msf_id=session_id)
