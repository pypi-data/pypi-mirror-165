...
from cryton_core.cryton_app.models import RunModel, PlanModel, PlanExecutionModel, WorkerModel
from cryton_core.lib.util import exceptions, logger, scheduler_client, states as st
from cryton_core.lib.models import stage, plan, step
...
class Run:
    ...
    def validate_modules(self):
        ...
        for plan_execution_id in self.model.plan_executions.values_list('id', flat=True):
            plan_execution = plan.PlanExecution(plan_execution_id=plan_execution_id)
