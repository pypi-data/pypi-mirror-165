...
from python_backtesting_engine import config
from python_backtesting_engine.Brownian_Motion import brownian
...
class BrownianMotion:
    ...
    def save_csv(self):
        df = self.to_df()
        df.to_csv('./python_backtesting_engine/data/brownian_data.csv')
