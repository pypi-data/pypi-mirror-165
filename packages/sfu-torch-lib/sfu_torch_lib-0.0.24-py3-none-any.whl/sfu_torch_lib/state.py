import logging
import os
from typing import Type, Mapping, Dict, Any, Optional
...
def get_checkpoint(run_id: str, filename: str = 'last') -> Dict[str, Any]:
    checkpoint_path = get_checkpoint_path(run_id, filename)
...
def load_checkpoint_state(checkpoint: Mapping[str, Any], model: LightningModule) -> None:
...
def load_state(run_id: str, model: LightningModule, filename: str = 'last') -> None:
    ...
    load_checkpoint_state(checkpoint, model)
