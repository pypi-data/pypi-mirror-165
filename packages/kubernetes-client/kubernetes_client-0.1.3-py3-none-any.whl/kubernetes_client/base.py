...
class KubernetesManager:
    ...
    def check_sa_exists(self, name, namespace="default"):
        ...
        sa_list = self.k_client.list_namespaced_service_account(namespace=namespace)
    ...
    def check_secret_exists(self, name, namespace="default"):
        ...
        se_list = self.k_client.list_namespaced_secret(namespace=namespace)
    ...
    def prepare_service_account(self, name, namespace="default", labels=None, secret_name=None,
                            image_pull_secret_name=None):
