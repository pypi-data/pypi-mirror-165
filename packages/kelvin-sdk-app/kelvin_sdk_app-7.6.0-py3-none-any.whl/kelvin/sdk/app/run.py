        ...
        with timestamper(lambda: int(context.process_time * 1e9)):
            ...
            while True:
                ...
                try:
                    ...
                    if core_config:
                        trash = []
                        if file_watcher and file_watcher.check():
                            init_p = file_watcher.get_updates("app.kelvin.parameters")
                            if init_p:
                                app._init_parameters(init_p)

                            asset_p = file_watcher.get_updates("app.kelvin.assets")
                            if asset_p:
