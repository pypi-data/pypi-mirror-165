...
class ApplicationInterface:
    ...
    def on_parameter(self, parameter: Union[Sequence[Any], Mapping[str, Any]]) -> bool:
        """
    ...
    def _on_parameter(self, parameter: Union[Sequence[Any], Mapping[str, Any]]) -> bool:
        """
        The on_parameter() method is called every time the application's
        configuration is modified. This callback will be triggered once after
        initialize() and then once every time the configuration is modified.
    ...
    def _init_parameters(self, parameter: Union[Sequence[Any], Mapping[str, Any]]) -> bool:
        """
        The on_parameter() method is called every time the application's
        configuration is modified. This callback will be triggered once after
        initialize() and then once every time the configuration is modified.
    ...
    def core_init(
        ...
        **kwargs: Any,
        ...
        inputs, outputs, config, params, _ = get_io(core_config)
