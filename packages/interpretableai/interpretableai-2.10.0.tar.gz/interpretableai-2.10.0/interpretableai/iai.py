...
class acquire_license(object):
    ...
    Julia Equivalent:
    `IAI.acquire_license <https://docs.interpretable.ai/v3.1.0/installation/#IAI.acquire_license>`
...
def release_license(*args, parallel_processes=None, **kwargs):
    ...
    Julia Equivalent:
    `IAI.release_license <https://docs.interpretable.ai/v3.1.0/installation/#IAI.release_license>`
