...
def impute(*args, **kwargs):
    ...
    Julia Equivalent:
    `IAI.impute <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.impute>`
...
def impute_cv(*args, **kwargs):
    ...
    Julia Equivalent:
    `IAI.impute_cv <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.impute_cv>`
...
class ImputationLearner(UnsupervisedLearner):
    ...
    Julia Equivalent:
    `IAI.ImputationLearner <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.ImputationLearner>`
    ...
    def fit(self, *args, **kwargs):
        ...
        Julia Equivalent:
        `IAI.fit! <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.fit%21-Tuple%7BLearner%7BIAIBase.ImputationTask%7D%7D>`
    ...
    def fit_transform(self, *args, **kwargs):
        ...
        Julia Equivalent:
        `IAI.fit_transform! <https://docs.interpretable.ai/v3.1.0/IAIBase/reference/#IAI.fit_transform!>`
        ...
        `data preparation <https://docs.interpretable.ai/v3.1.0/IAI-Python/data/#Python-Data-Preparation-Guide-1>`
    ...
    def transform(self, *args, **kwargs):
        ...
        Julia Equivalent:
        `IAI.transform <https://docs.interpretable.ai/v3.1.0/IAIBase/reference/#IAI.transform>`
    ...
    def fit_and_expand(self, *args, **kwargs):
        ...
        Julia Equivalent:
        `IAI.fit_and_expand! <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.fit_and_expand%21>`
    ...
    def transform_and_expand(self, *args, **kwargs):
        ...
        Julia Equivalent:
        `IAI.transform_and_expand <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.transform_and_expand>`
...
class OptKNNImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.OptKNNImputationLearner <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.OptKNNImputationLearner>`
...
class OptSVMImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.OptSVMImputationLearner <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.OptSVMImputationLearner>`
...
class OptTreeImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.OptTreeImputationLearner <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.OptTreeImputationLearner>`
...
class SingleKNNImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.SingleKNNImputationLearner <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.SingleKNNImputationLearner>`
...
class MeanImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.MeanImputationLearner <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.MeanImputationLearner>`
...
class RandImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.RandImputationLearner <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.RandImputationLearner>`
...
class ZeroImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.ZeroImputationLearner <https://docs.interpretable.ai/v3.1.0/OptImpute/reference/#IAI.ZeroImputationLearner>`
