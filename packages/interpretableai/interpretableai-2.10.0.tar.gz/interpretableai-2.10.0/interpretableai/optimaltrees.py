...
class OptimalTreeLearner(TreeLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalTreeLearner <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.OptimalTreeLearner>`
    """
    ...
    def refit_leaves(self, *args, refit_learner=None, **kwargs):
        ...
        Julia Equivalent:
        `IAI.refit_leaves! <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.refit_leaves!>`
    ...
    def copy_splits_and_refit_leaves(self, orig_lnr, *args, refit_learner=None,
        ...
        Julia Equivalent:
        `IAI.copy_splits_and_refit_leaves! <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.copy_splits_and_refit_leaves!>`
    ...
    def prune_trees(self, *args, **kwargs):
        ...
        Julia Equivalent:
        `IAI.prune_trees! <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.prune_trees!>`
...
class OptimalTreeClassifier(OptimalTreeLearner, ClassificationTreeLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalTreeClassifier <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.OptimalTreeClassifier>`
...
class OptimalTreeRegressor(OptimalTreeLearner, RegressionTreeLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalTreeRegressor <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.OptimalTreeRegressor>`
...
class OptimalTreeSurvivalLearner(OptimalTreeLearner, SurvivalTreeLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalTreeSurvivalLearner <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.OptimalTreeSurvivalLearner>`
...
class OptimalTreePrescriptionMinimizer(OptimalTreeLearner,
    ...
    Julia Equivalent:
    `IAI.OptimalTreePrescriptionMinimizer <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.OptimalTreePrescriptionMinimizer>`
...
class OptimalTreePrescriptionMaximizer(OptimalTreeLearner,
    ...
    Julia Equivalent:
    `IAI.OptimalTreePrescriptionMaximizer <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.OptimalTreePrescriptionMaximizer>`
...
class OptimalTreePolicyMinimizer(OptimalTreeLearner, PolicyTreeLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalTreePolicyMinimizer <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.OptimalTreePolicyMinimizer>`
...
class OptimalTreePolicyMaximizer(OptimalTreeLearner, PolicyTreeLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalTreePolicyMaximizer <https://docs.interpretable.ai/v3.1.0/OptimalTrees/reference/#IAI.OptimalTreePolicyMaximizer>`
