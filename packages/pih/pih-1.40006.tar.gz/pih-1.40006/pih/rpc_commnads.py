...
class RPC_COMMANDS:
    ...
    class USER(AD):
        ...
        @staticmethod
        def get_user_by_job_position(job_position: CONST.AD.JobPositions) -> dict:
            return RPC.call(RPC_COMMANDS.USER.create_rpc_command("get_user_by_job_position"), job_position.name)
