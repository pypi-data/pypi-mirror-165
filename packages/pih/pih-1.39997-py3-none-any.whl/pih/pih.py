...
from pih.collection import ActionValue, CommandChainItem, CommandLinkItem, FieldItem, CommandItem, FieldItemList, FullName, LogCommand, LoginPasswordPair, Mark, MarkGroup, MarkGroupStatistics, ParamItem, PasswordSettings, PrinterADInformation, PrinterReport, Result, TimeTrackingItem, User, UserContainer
...
class PIH:
    ...
    class RESULT:
        ...
        class MARK:
            ...
            @staticmethod
            def time_tracking(start_date: datetime = None, end_date: datetime = None, tab_number: str = None) -> Result[List[TimeTrackingItem]]:
                now: datetime = None
                ...
                return DataTools.to_result(RPC_COMMANDS.MARK.get_time_tracking(start_date, end_date, tab_number), TimeTrackingItem)
        ...
        class USER:
            ...
            @staticmethod
            def by_any(value: str | FullName) -> Result[List[User]]:
