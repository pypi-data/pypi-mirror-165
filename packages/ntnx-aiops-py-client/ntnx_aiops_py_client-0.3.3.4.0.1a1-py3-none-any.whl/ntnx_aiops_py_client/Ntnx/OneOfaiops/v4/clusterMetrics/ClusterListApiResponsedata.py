...
class ClusterListApiResponsedata(object):
    """ClusterListApiResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    discriminator_value_class_map = {
        'EMPTY_LIST': 'list[str]',
        'List<aiops.v4.clusterMetrics.ClusterMetrics>': 'list[aiops.v4.clusterMetrics.ClusterMetrics]',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.clusterMetrics.ClusterListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClusterListApiResponsedata.discriminator_value_class_map.values():
            return list(ClusterListApiResponsedata.discriminator_value_class_map.keys())[list(ClusterListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterListApiResponsedata):
            return False
