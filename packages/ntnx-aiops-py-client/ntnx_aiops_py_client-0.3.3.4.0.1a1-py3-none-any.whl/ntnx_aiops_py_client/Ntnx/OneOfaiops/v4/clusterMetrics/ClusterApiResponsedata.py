...
class ClusterApiResponsedata(object):
    """ClusterApiResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    discriminator_value_class_map = {
        'EMPTY_LIST': 'list[str]',
        'aiops.v4.clusterMetrics.ClusterMetrics': 'aiops.v4.clusterMetrics.ClusterMetrics',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.clusterMetrics.ClusterApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ClusterApiResponsedata.discriminator_value_class_map.values():
            return list(ClusterApiResponsedata.discriminator_value_class_map.keys())[list(ClusterApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterApiResponsedata):
            return False
