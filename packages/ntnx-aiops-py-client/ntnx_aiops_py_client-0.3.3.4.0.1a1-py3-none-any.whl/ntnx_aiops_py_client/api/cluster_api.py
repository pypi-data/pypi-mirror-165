...
class ClusterApi(object):
    ...
    def get_cluster_resource_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        >>> response = api.get_cluster_resource_by_id(extId)

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_cluster_resource_by_id(extId, async_req=True)
        >>> result = thread.get()

        :param str extId: The UUID of the cluster (required)
        :param bool async_req:
        :return: aiops.v4.clusterMetrics.ClusterApiResponse
        ...
        if kwargs.get('async_req'):
            return self.get_cluster_resource_by_id_with_http_info(extId, **kwargs)  # noqa: E501
        else:
            (data) = self.get_cluster_resource_by_id_with_http_info(extId, **kwargs)  # noqa: E501
            return data

    def get_cluster_resource_by_id_with_http_info(self, extId, **kwargs):  # noqa: E501
        """Returns information regarding the total, used and available resources (cpu, memory, storage) for the given cluster
        Fetch information about resource usage of given cluster
        ...
        >>> thread = api.get_cluster_resource_by_id_with_http_info(extId, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_cluster_resource_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('extId' not in params or
            ...
            raise ValueError("Missing the required parameter `extId` when calling `get_cluster_resource_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/aiops/v4.0.a1/cluster-metrics/{extId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='aiops.v4.clusterMetrics.ClusterApiResponse',  # noqa: E501
    ...
    def list_resources_for_all_clusters(self, **kwargs):  # noqa: E501
        ...
        >>> response = api.list_resources_for_all_clusters((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_resources_for_all_clusters(async_req=True)
        >>> result = thread.get()
        ...
        :param bool async_req:
        :return: aiops.v4.clusterMetrics.ClusterListApiResponse
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_resources_for_all_clusters_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_resources_for_all_clusters_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_resources_for_all_clusters_with_http_info(self, **kwargs):  # noqa: E501
        """Returns information regarding the total, used and available resources (cpu, memory, storage) for all the clusters in Prism Central
        Fetch information about resource usage for all the clusters in Prism Central
        ...
        >>> thread = api.list_resources_for_all_clusters_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_resources_for_all_clusters" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/aiops/v4.0.a1/cluster-metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='aiops.v4.clusterMetrics.ClusterListApiResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
