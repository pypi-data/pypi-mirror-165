...
from ntnx_aiops_py_client.Ntnx.OneOfaiops.v4.error.ErrorResponseerror import ErrorResponseerror  # noqa: F401,E501
...
class ErrorResponse(object):
    ...
    def _initialize_fq_object_type(self):
        return 'aiops.v4.r0.a1.error.ErrorResponse'
    ...
    @property
    def error(self):
        """`{ list[aiops.v4.error.AppMessage] | aiops.v4.error.SchemaValidationError }`
