...
class ApplicationEndpointProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApplicationEndpointProps.__init__)
...
class CloudWatchAgent(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudWatchAgent.__init__)
...
class CloudWatchAgentProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudWatchAgentProps.__init__)
...
class CloudWatchConfigBuilder(
    ...
    def __init__(
        self,
        log_flush_interval: typing.Optional[aws_cdk.Duration] = None,
    ) -> None:
        '''Constructs.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudWatchConfigBuilder.__init__)
    ...
    def add_logs_collect_list(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CloudWatchConfigBuilder.add_logs_collect_list)
    ...
    def log_flush_interval(self) -> aws_cdk.Duration:
        '''Flush interval of the Cloud Watch Agent (in Seconds).'''
        return typing.cast(aws_cdk.Duration, jsii.get(self, "logFlushInterval"))
...
class ConnectableApplicationEndpointProps(ApplicationEndpointProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ConnectableApplicationEndpointProps.__init__)
            check_type(argname="argument address", value=address, expected_type=type_hints["address"])
            check_type(argname="argument port", value=port, expected_type=type_hints["port"])
            check_type(argname="argument protocol", value=protocol, expected_type=type_hints["protocol"])
...
class ConventionalScriptPathParams:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ConventionalScriptPathParams.__init__)
...
class DistinguishedName:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DistinguishedName.__init__)
...
class EndpointProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EndpointProps.__init__)
            check_type(argname="argument address", value=address, expected_type=type_hints["address"])
            check_type(argname="argument port", value=port, expected_type=type_hints["port"])
            check_type(argname="argument protocol", value=protocol, expected_type=type_hints["protocol"])
        self._values: typing.Dict[str, typing.Any] = {
...
class ExecuteScriptProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ExecuteScriptProps.__init__)
            check_type(argname="argument host", value=host, expected_type=type_hints["host"])
...
class ExportingLogGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ExportingLogGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class ExportingLogGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ExportingLogGroupProps.__init__)
...
class HealthMonitorProps:
    def __init__(
        ...
        *,
        ...
        elb_account_limits: typing.Optional[typing.Sequence[typing.Union["Limit", typing.Dict[str, typing.Any]]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(HealthMonitorProps.__init__)
...
class IHealthMonitor(constructs.IConstruct, typing_extensions.Protocol):
...
class _IHealthMonitorProxy(
    ...
    def register_fleet(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IHealthMonitor.register_fleet)
...
class _IMongoDbProxy(
    ...
    def add_security_group(
        ...
        *security_groups: aws_cdk.aws_ec2.ISecurityGroup,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IMongoDb.add_security_group)
...
class _IMountableLinuxFilesystemProxy:
    ...
    def mount_to_linux_instance(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IMountableLinuxFilesystem.mount_to_linux_instance)
...
class IX509CertificatePem(constructs.IConstruct, typing_extensions.Protocol):
...
class IX509CertificatePkcs12(constructs.IConstruct, typing_extensions.Protocol):
...
class ImportedAcmCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ImportedAcmCertificate.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def apply_removal_policy(self, policy: aws_cdk.RemovalPolicy) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ImportedAcmCertificate.apply_removal_policy)
...
class ImportedAcmCertificateProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ImportedAcmCertificateProps.__init__)
...
class Limit:
    def __init__(self, *, max: jsii.Number, name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Limit.__init__)
...
class LinuxMountPointProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LinuxMountPointProps.__init__)
...
class LogGroupFactory(metaclass=jsii.JSIIMeta, jsii_type="aws-rfdk.LogGroupFactory"):
    ...
    def create_or_fetch(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LogGroupFactory.create_or_fetch)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class LogGroupFactoryProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LogGroupFactoryProps.__init__)
            check_type(argname="argument bucket_name", value=bucket_name, expected_type=type_hints["bucket_name"])
...
class MongoDbApplicationProps:
    def __init__(
        ...
        *,
        ...
        mongo_data_volume: typing.Optional[typing.Union["MongoDbInstanceVolumeProps", typing.Dict[str, typing.Any]]] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbApplicationProps.__init__)
...
class MongoDbInstaller(metaclass=jsii.JSIIMeta, jsii_type="aws-rfdk.MongoDbInstaller"):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstaller.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def install_on_linux_instance(self, target: IScriptHost) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstaller.install_on_linux_instance)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
...
class MongoDbInstallerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstallerProps.__init__)
            check_type(argname="argument version", value=version, expected_type=type_hints["version"])
            check_type(argname="argument user_sspl_acceptance", value=user_sspl_acceptance, expected_type=type_hints["user_sspl_acceptance"])
        self._values: typing.Dict[str, typing.Any] = {
            "version": version,
...
class MongoDbInstance(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        mongo_db: typing.Union[MongoDbApplicationProps, typing.Dict[str, typing.Any]],
        vpc: aws_cdk.aws_ec2.IVpc,
        instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType] = None,
        key_name: typing.Optional[builtins.str] = None,
        log_group_props: typing.Optional[typing.Union[LogGroupFactoryProps, typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstance.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_security_group(
        ...
        *security_groups: aws_cdk.aws_ec2.ISecurityGroup,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstance.add_security_group)
            check_type(argname="argument security_groups", value=security_groups, expected_type=typing.Tuple[type_hints["security_groups"], ...])
        return typing.cast(None, jsii.invoke(self, "addSecurityGroup", [*security_groups]))
    ...
    def _configure_cloud_watch_log_streams(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstance._configure_cloud_watch_log_streams)
            check_type(argname="argument host", value=host, expected_type=type_hints["host"])
    ...
    def _configure_mongo_db(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstance._configure_mongo_db)
...
class MongoDbInstanceNewVolumeProps:
    def __init__(
        ...
        *,
        encryption_key: typing.Optional[aws_cdk.aws_kms.IKey] = None,
        size: typing.Optional[aws_cdk.Size] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstanceNewVolumeProps.__init__)
            check_type(argname="argument encryption_key", value=encryption_key, expected_type=type_hints["encryption_key"])
    ...
    @builtins.property
    def size(self) -> typing.Optional[aws_cdk.Size]:
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(vpc_subnets, dict):
            vpc_subnets = aws_cdk.aws_ec2.SubnetSelection(**vpc_subnets)
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstanceProps.__init__)
...
class MongoDbInstanceVolumeProps:
    def __init__(
        ...
        *,
        ...
        volume_props: typing.Optional[typing.Union[MongoDbInstanceNewVolumeProps, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        ...
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbInstanceVolumeProps.__init__)
...
class MongoDbPostInstallSetup(
    ...
    def __init__(
        ...
        *,
        mongo_db: IMongoDb,
        users: typing.Union["MongoDbUsers", typing.Dict[str, typing.Any]],
        vpc: aws_cdk.aws_ec2.IVpc,
        vpc_subnets: typing.Optional[typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbPostInstallSetup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(vpc_subnets, dict):
            vpc_subnets = aws_cdk.aws_ec2.SubnetSelection(**vpc_subnets)
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbPostInstallSetupProps.__init__)
            check_type(argname="argument mongo_db", value=mongo_db, expected_type=type_hints["mongo_db"])
...
class MongoDbUsers:
    def __init__(
        ...
        *,
        ...
        x509_auth_users: typing.Optional[typing.Sequence[typing.Union["MongoDbX509User", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbUsers.__init__)
...
class MongoDbX509User:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MongoDbX509User.__init__)
...
class MountableBlockVolume(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableBlockVolume.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def _grant_required_permissions(self, target: "IMountingInstance") -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableBlockVolume._grant_required_permissions)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
    ...
    def _mount_asset_singleton(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableBlockVolume._mount_asset_singleton)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def mount_to_linux_instance(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableBlockVolume.mount_to_linux_instance)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        mount = LinuxMountPointProps(location=location, permissions=permissions)
...
class MountableBlockVolumeProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableBlockVolumeProps.__init__)
...
class MountableEfs(metaclass=jsii.JSIIMeta, jsii_type="aws-rfdk.MountableEfs"):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableEfs.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def _mount_asset_singleton(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableEfs._mount_asset_singleton)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(aws_cdk.aws_s3_assets.Asset, jsii.invoke(self, "mountAssetSingleton", [scope]))
    ...
    def mount_to_linux_instance(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableEfs.mount_to_linux_instance)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        mount = LinuxMountPointProps(location=location, permissions=permissions)
...
class MountableEfsProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableEfsProps.__init__)
...
class MountableFsxLustre(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableFsxLustre.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def _mount_asset_singleton(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableFsxLustre._mount_asset_singleton)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(aws_cdk.aws_s3_assets.Asset, jsii.invoke(self, "mountAssetSingleton", [scope]))
    ...
    def mount_to_linux_instance(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableFsxLustre.mount_to_linux_instance)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
        mount = LinuxMountPointProps(location=location, permissions=permissions)
...
class MountableFsxLustreProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(MountableFsxLustreProps.__init__)
            check_type(argname="argument filesystem", value=filesystem, expected_type=type_hints["filesystem"])
            check_type(argname="argument extra_mount_options", value=extra_mount_options, expected_type=type_hints["extra_mount_options"])
...
class PadEfsStorage(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PadEfsStorage.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class PadEfsStorageProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(vpc_subnets, dict):
            vpc_subnets = aws_cdk.aws_ec2.SubnetSelection(**vpc_subnets)
        if __debug__:
            type_hints = typing.get_type_hints(PadEfsStorageProps.__init__)
            check_type(argname="argument access_point", value=access_point, expected_type=type_hints["access_point"])
    ...
    @builtins.property
    def desired_padding(self) -> aws_cdk.Size:
        ...
        return typing.cast(aws_cdk.Size, result)
...
class ScriptAsset(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ScriptAsset.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def from_path_convention(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ScriptAsset.from_path_convention)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class ScriptAssetProps(aws_cdk.aws_s3_assets.AssetProps):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ScriptAssetProps.__init__)
    ...
    @builtins.property
    def follow_symlinks(self) -> typing.Optional[aws_cdk.SymlinkFollowMode]:
        '''A strategy for how to handle symlinks.

        :default: SymlinkFollowMode.NEVER
        '''
        result = self._values.get("follow_symlinks")
        return typing.cast(typing.Optional[aws_cdk.SymlinkFollowMode], result)

    @builtins.property
    def ignore_mode(self) -> typing.Optional[aws_cdk.IgnoreMode]:
        '''The ignore behavior to use for exclude patterns.

        :default: IgnoreMode.GLOB
        '''
        result = self._values.get("ignore_mode")
        return typing.cast(typing.Optional[aws_cdk.IgnoreMode], result)
...
class SessionManagerHelper(
    ...
    def grant_permissions_to(cls, grantable: aws_cdk.aws_iam.IGrantable) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SessionManagerHelper.grant_permissions_to)
...
class StaticPrivateIpServer(
    ...
    def __init__(
        ...
        *,
        ...
        resource_signal_timeout: typing.Optional[aws_cdk.Duration] = None,
        role: typing.Optional[aws_cdk.aws_iam.IRole] = None,
        security_group: typing.Optional[aws_cdk.aws_ec2.ISecurityGroup] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StaticPrivateIpServer.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def _attach_eni_lifecyle_target(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StaticPrivateIpServer._attach_eni_lifecyle_target)
    ...
    def _setup_lifecycle_notification_topic(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StaticPrivateIpServer._setup_lifecycle_notification_topic)
...
class StaticPrivateIpServerProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(vpc_subnets, dict):
            vpc_subnets = aws_cdk.aws_ec2.SubnetSelection(**vpc_subnets)
        if __debug__:
            type_hints = typing.get_type_hints(StaticPrivateIpServerProps.__init__)
            check_type(argname="argument instance_type", value=instance_type, expected_type=type_hints["instance_type"])
    ...
    @builtins.property
    def resource_signal_timeout(self) -> typing.Optional[aws_cdk.Duration]:
...
class X509CertificatePem(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        subject: typing.Union[DistinguishedName, typing.Dict[str, typing.Any]],
        encryption_key: typing.Optional[aws_cdk.aws_kms.IKey] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(X509CertificatePem.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def grant_cert_read(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(X509CertificatePem.grant_cert_read)
    ...
    def grant_full_read(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(X509CertificatePem.grant_full_read)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
    ...
    def _database(self, value: aws_cdk.aws_dynamodb.Table) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(X509CertificatePem, "_database").fset)
    ...
    def _lambda_func(self, value: aws_cdk.aws_lambda.Function) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(X509CertificatePem, "_lambda_func").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    @_unique_tag.setter
    def _unique_tag(self, value: aws_cdk.Tag) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(X509CertificatePem, "_unique_tag").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class X509CertificatePemProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(X509CertificatePemProps.__init__)
...
class X509CertificatePkcs12(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(X509CertificatePkcs12.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def _database(self, value: aws_cdk.aws_dynamodb.Table) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(X509CertificatePkcs12, "_database").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "database", value)
    ...
    def _lambda_func(self, value: aws_cdk.aws_lambda.Function) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(X509CertificatePkcs12, "_lambda_func").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "lambdaFunc", value)
    ...
    def _unique_tag(self, value: aws_cdk.Tag) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(X509CertificatePkcs12, "_unique_tag").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "uniqueTag", value)
...
class X509CertificatePkcs12Props:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(X509CertificatePkcs12Props.__init__)
...
class HealthMonitor(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HealthMonitor.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def register_fleet(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(HealthMonitor.register_fleet)
            check_type(argname="argument monitorable_fleet", value=monitorable_fleet, expected_type=type_hints["monitorable_fleet"])
        health_check_config = HealthCheckConfig(
            healthy_fleet_threshold_percent=healthy_fleet_threshold_percent,
            instance_healthy_threshold_count=instance_healthy_threshold_count,
    ...
    def DEFAULT_HEALTH_CHECK_INTERVAL(cls) -> aws_cdk.Duration:
        '''Resource Tracker in Deadline currently publish health status every 5 min, hence keeping this same.'''
        return typing.cast(aws_cdk.Duration, jsii.sget(cls, "DEFAULT_HEALTH_CHECK_INTERVAL"))
