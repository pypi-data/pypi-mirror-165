...
from ..utils import forecasting_utils as futil
...
class Forecaster:
    ...
    def forecast(
        self, iter: list, by=5, decimals: int = 0, factor_: float = None
    ) -> np.ndarray:
        """
    ...
    def forecasts(self, *iters: list, by: int = 5, decimals: int = 0) -> list:
        """
